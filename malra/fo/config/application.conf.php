...
error_reporting(0);
//=============ApplicationId========================
$application['application_id'] = 301; //Portal Kepegawaian
//=============directory============================
...
$application['db_conn'][0]['db_name'] = 'gtsdm_gorontalo_final';
...
//============default page============================
$application['default_module'] = 'home';
$application['default_submodule'] = 'home';
...
//============development============================
$application['debug_mode'] = FALSE;//FALSE;
...
$application['syslog_log_path'] = 'D:/www/produk/';
...
$application['wsdl_cache_path'] = 'D:/www/produk/'; // use cached wsdl if available
...
//================ photo_save_path =====================
$application['bo_save_path']="C:/xampp/htdocs/gtsdm_gorontalo_project/trunk/devel/bkd_gto/bo/";
$application['bo_download_path']="/bkd_gto/bo/";

$application['file_berita'] = $application['bo_save_path']."upload_file/file_berita/";
$application['file_agenda'] = $application['bo_save_path']."upload_file/file_agenda/";
$application['photo_save_path'] = $application['bo_save_path']."upload_file/photo/";
$application['klaim_save_path'] = $application['bo_save_path']."upload_file/file_klaim/";
$application['policy_save_path'] = $application['bo_save_path']."upload_file/file_policy/";
$application['file_save_path'] = $application['bo_save_path']."upload_file/file/";
$application['template_email_path'] = $application['bo_save_path']."module/email/template/";

$application['berita_download_path'] = $application['baseaddress'].$application['bo_download_path']."upload_file/file_berita/";
$application['agenda_download_path'] = $application['baseaddress'].$application['bo_download_path']."upload_file/file_agenda/";
$application['klaim_download_path'] = $application['baseaddress'].$application['bo_download_path']."upload_file/file_klaim/";
$application['policy_download_path'] = $application['baseaddress'].$application['bo_download_path']."upload_file/file_policy/";
$application['file_download_path'] = $application['baseaddress'].$application['bo_download_path']."upload_file/file/";
$application['photo_download_path'] = $application['baseaddress'].$application['bo_download_path']."upload_file/photo/";
//================Language=====================
