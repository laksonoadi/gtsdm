...
class ViewUpdateAgenda extends HtmlResponse {
   ...
   function ParseTemplate($data = NULL) {
      ...
      if(!empty($data['agenda'])){
         ...
         if(!empty($agenda['FOTO'])){
            ...
            $this->mrTemplate->addVar('foto','FOTO',$agenda['FOTO']);
         }
   ...
   function DoUpdateAgenda($fileName){
      ...
      return $this->mAgenda->UpdateAgenda($_POST['title'],$_POST['article'],$tanggal_mulai,$tanggal_selesai,$_POST['tempat'],$_POST['url'],$fileName,$_POST['caption'],$status,$sender,$_POST['id']);
   }
}
?>