...
class ViewDetailDataBenefit extends HtmlResponse
{
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_BACK', Dispatcher::Instance()->GetUrl('approval_benefit', 'historyDataBenefit', 'view', 'html') . '&dataId=' . $idEnc. '&pilihpegawai=' . Dispatcher::Instance()->Encrypt($_GET['pilihpegawai']) );
