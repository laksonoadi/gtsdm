...
class ViewCetakDataTaf extends HtmlResponse
{
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_BACK', Dispatcher::Instance()->GetUrl('approval_taf', 'historyDataTaf', 'view', 'html') . '&dataId=' . $idEnc );
      ...
      $this->mrTemplate->AddVars('content', $detailPegawai, 'DATA_');
