...
require_once GTFWConfiguration::GetValue( 'application', 'docroot').
   'module/data_lembur_kompensasi/business/lembur.class.php';
...
class ViewDetailDataLembur extends HtmlResponse
{
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_BACK', Dispatcher::Instance()->GetUrl('approval_lembur_kompensasi', 'historyDataLembur', 'view', 'html') . '&dataId=' . $idEnc );
