...
class ViewDataLembur extends HtmlResponse
{
   function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
         'module/approval_lembur_kompensasi/'.GTFWConfiguration::GetValue('application', 'template_address').'');
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $buttonlang=GTFWConfiguration::GetValue('application', 'button_lang');
       if ($buttonlang=='eng'){
         $this->mrTemplate->AddVar('content', 'TITLE', 'OVERTIME COMPESATION');
      ...
      $this->mrTemplate->AddVar('content', 'URL_BACK', Dispatcher::Instance()->GetUrl('approval_lembur_kompensasi', 'historyDataLembur', 'view', 'html') . '&dataId=' . $_GET['dataId'].'&pilihpegawai=' . $_GET['pilihpegawai'].'&status='.$dat['status']);
      $this->mrTemplate->AddVar('content', 'URL_AKSI', Dispatcher::Instance()->GetUrl('approval_lembur_kompensasi', 'inputDataLembur', 'do', 'html')); 
