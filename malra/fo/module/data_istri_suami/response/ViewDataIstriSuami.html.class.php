...
class ViewDataIstriSuami extends HtmlResponse
{
   ...
   function ProcessRequest()
   {
      ...
      if ($rs['jenis_kelamin']=='L'){
        $hub = array(0=>array('id'=>Istri,'name'=>$ll));
      }else{
        $hub = array(0=>array('id'=>Suami,'name'=>$pp));
      }
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_TAMBAH', Dispatcher::Instance()->GetUrl('data_istri_suami', 'dataIstriSuami', 'view', 'html').'&aksi=ya');
      $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('data_istri_suami', 'dataIstriSuami', 'view', 'html'));
  ...
  //mulai bikin tombol delete
        ...
        for ($i=0; $i<count($dataIstri); $i++) {
          ...
          $dataIstri[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('data_istri_suami','dataIstriSuami', 'view', 'html').'&dataId2='. $idEnc.'&dataId='. $idEnc2.'&aksi=ya';
