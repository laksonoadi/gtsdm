...
class ViewDataOrangTua extends HtmlResponse
{
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_TAMBAH', Dispatcher::Instance()->GetUrl('data_orang_tua', 'dataOrangTua', 'view', 'html').'&aksi=ya');
      $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('data_orang_tua', 'dataOrangTua', 'view', 'html'));
  ...
  //mulai bikin tombol delete
        ...
        for ($i=0; $i<count($dataOrtu); $i++) {
          ...
          $dataOrtu[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('data_orang_tua','dataOrangTua', 'view', 'html').'&dataId2='. $idEnc.'&dataId='. $idEnc2.'&aksi=ya';
