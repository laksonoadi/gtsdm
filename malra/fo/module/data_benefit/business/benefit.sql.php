...
SELECT
  klaimbenefitId as 'id_klaim',
  klaimbenefitBenefitId as 'benefit_id',
  klaimbenefitJnsklaimId as 'id_tipe_klaim',
...
INSERT INTO 
   sdm_benefit
   (benefitNo,benefitBalancebenefitId,
    benefitPegId,benefitNamaPasien,
    benefitRelasiPasien,benefitBenefitId,
    benefitTgl,benefitTglSubmit,
    benefitTempat,benefitTotalKlaim,
    benefitAlasan,benefitTglKlaim,
    benefitStatus)
VALUES('%s','%s',
       '%s','%s',
       '%s','%s',
...
INSERT INTO 
   sdm_benefit_klaim
   (klaimbenefitBenefitId,klaimbenefitJnsklaimId,klaimbenefitNilai,klaimbenefitFile)
VALUES('%s','%s','%s','%s')  
";
...
SET 
	benefitNo='%s',
	benefitBalancebenefitId='%s',
	benefitPegId='%s',
	benefitNamaPasien='%s',
	benefitRelasiPasien='%s',
	benefitBenefitId='%s',
	benefitTgl='%s',
	benefitTglSubmit=now(),
	benefitTempat='%s',
	benefitTotalKlaim='%s',
	benefitAlasan='%s',
	benefitTglKlaim='%s',
...
$sql['do_update_nilai_klaim'] = "
UPDATE sdm_benefit_klaim
SET
  klaimbenefitNilaiDisetujui='%s'
WHERE 
   klaimbenefitId = %s  
";
...
SET
  ...
  balancebenefitTotal = balancebenefitTotal
WHERE 
  balancebenefitPegId	= %s
