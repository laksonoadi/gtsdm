...
require_once GTFWConfiguration::GetValue( 'application', 'docroot').'module/mutasi_satuan_kerja/business/mutasi_satuan_kerja.class.php';
   ...
   class ViewDetailMutasi extends HtmlResponse
   {
      ...
      function ProcessRequest()
      {
         ...
         $return['link']['url_back'] = Dispatcher::Instance()->GetUrl('mutasi_satuan_kerja','MutasiSatuanKerja','view','html').'&id='.$profilId;
      ...
      function ParseTemplate($data = NULL)
      {
         ...
         $link = $data['link'];
         $this->mrTemplate->AddVar('content', 'TITLE', 'DETAIL MUTASI JABATAN STRUKTURAL');
