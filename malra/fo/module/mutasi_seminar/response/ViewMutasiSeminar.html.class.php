...
class ViewMutasiSeminar extends HtmlResponse
   {
      ...
      //print_r($dataPegawai);
      //print_r($dataSem);
      $this->mrTemplate->AddVar('content', 'TITLE', 'SEMINAR');
      ...
      $this->mrTemplate->AddVar('content', 'URL_TAMBAH', Dispatcher::Instance()->GetUrl('mutasi_seminar', 'MutasiSeminar', 'view', 'html').'&aksi=ya');
      $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('mutasi_seminar', 'MutasiSeminar', 'view', 'html'));
      ...
      $dataName = $dataSem[$i]['nama'];
         ...
         $dataSem[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('mutasi_seminar','MutasiSeminar', 'view', 'html').'&id='.$dataPegawai[0]['id'].'&dataId='. $idEnc.'&aksi=ya';
