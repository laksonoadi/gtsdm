<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot') . 'module/mutasi_bkd/business/mutasi_bkd.class.php';
...
// exit;
  ...
  function ParseTemplate($data = NULL)
  {
    ...
    $this->mrTemplate->AddVar('content', 'LABEL_FORM', isset($_GET['dataId']) ? 'Update Data Beban Kinerja Dosen' : 'Tambah Data Beban Kinerja Dosen');
         
	$this->mrTemplate->AddVar('content', 'URL_TAMBAH', Dispatcher::Instance()->GetUrl('mutasi_bkd', 'MutasiBkd', 'view', 'html').'&aksi=ya');
    $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('mutasi_bkd', 'MutasiBkd', 'view', 'html') );
