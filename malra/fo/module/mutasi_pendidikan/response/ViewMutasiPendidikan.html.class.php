...
class ViewMutasiPendidikan extends HtmlResponse
   {
      ...
      $arrneg = $pend->GetComboNegara();
         ...
         $list_istamat=array(array('id'=>'Selesai','name'=>'Selesai'),array('id'=>'Masa Pendidikan','name'=>'Masa Pendidikan'));
	      ...
	      $list_lama=array(array('id'=>'1','name'=>'1'),array('id'=>'2','name'=>'2'),array('id'=>'3','name'=>'3'),array('id'=>'4','name'=>'4'),array('id'=>'5','name'=>'5'),array('id'=>'6','name'=>'6'),array('id'=>'7','name'=>'7'));
      ...
      //print_r($dataPegawai);
      //print_r($dataPend);
      $this->mrTemplate->AddVar('content', 'TITLE', 'PENDIDIKAN');
      ...
      $this->mrTemplate->AddVar('content', 'URL_TAMBAH', Dispatcher::Instance()->GetUrl('mutasi_pendidikan', 'MutasiPendidikan', 'view', 'html').'&aksi=ya');
      $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('mutasi_pendidikan', 'MutasiPendidikan', 'view', 'html'));
      ...
      $label = "Manajemen Data Mutasi Pendidikan";
      ...
      $dataName = $dataPend[$i]['institusi'];
         ...
         $dataPend[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('mutasi_pendidikan','MutasiPendidikan', 'view', 'html').'&id='.$dataPegawai[0]['id'].'&dataId='. $idEnc.'&aksi=ya';
