...
//==GET== 
   ...
   function GetDataLemburDet($id) {      
       $result = $this->Open($this->mSqlQueries['get_data_lembur_det'], array('%H:%i','%H','%i','%H:%i','%H','%i','%H:%i','%Y-%m-%d',$id));
       //echo sprintf($this->mSqlQueries['get_data_lembur_det'], '%H:%i','%H','%i','%H:%i','%H','%i','%H:%i','%Y-%m-%d',$id);
       //print_r($result); 
