   ...
   function ProcessRequest()
   {
	  ...
	  if(isset($_GET['id'])){
		 ...
		 if(!empty($result)){
		   ...
		   $return['input']['nama_eformasi'] = $result['nama_eformasi'];
		   $return['input']['jenisid'] = $result['jenisid'];
		   $return['input']['tingkat'] = $result['tingkat'];
		   $return['input']['jfparent'] = $result['jfparent'];
	     ...
	     $return['input']['nama'] = '';
	     $return['input']['nama_eformasi'] = '';
		   $return['input']['jenisid'] = '';
		   $return['input']['tingkat'] = '';
		   $return['input']['jfparent'] = '';
     ...
     $return['lang']=$lang;
	  ...
	  Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'jenis_jabatan', array('jenisid', $listJenisJabatan, $return['input']['jenisid'], 'false', 'id="jenisid "'), Messenger::CurrentRequest);
	  ...
	  $listJabfung=$jabatan->GetComboJabFung();
	  Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'jabfparent', array('jfparent', $listJabfung, $return['input']['jfparent'], 'false', 'id="jfparent "'), Messenger::CurrentRequest);
