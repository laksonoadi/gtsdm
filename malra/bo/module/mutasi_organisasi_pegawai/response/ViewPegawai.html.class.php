...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='RIWAYAT ORGANISASI PEGAWAI';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiOrganisasiPegawai',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
