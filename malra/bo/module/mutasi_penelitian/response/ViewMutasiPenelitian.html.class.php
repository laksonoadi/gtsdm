...
class ViewMutasiPenelitian extends HtmlResponse
   {
      ...
      $arrperanan = $pend->GetComboPeranan();
         ...
         #if ($tipe==1){
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'buku_jenis_buku_ref', array('buku_jenis_buku_ref', $arrjenisbuku, $return['input']['jenis_buku_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'buku_jenis_kegiatan_ref', array('buku_jenis_kegiatan_ref', $arrjeniskegiatan, $return['input']['jenis_kegiatan_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'buku_peranan_ref', array('buku_peranan_ref', $arrperanan, $return['input']['peranan_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
         #} else
         #if ($tipe==2){
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'artikel_jenis_buku_ref', array('artikel_jenis_buku_ref', $arrjenisbuku, $return['input']['jenis_buku_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'artikel_jenis_kegiatan_ref', array('artikel_jenis_kegiatan_ref', $arrjeniskegiatan, $return['input']['jenis_kegiatan_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'artikel_peranan_ref', array('artikel_peranan_ref', $arrperanan, $return['input']['peranan_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
         #} else
         #if ($tipe==3){
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'karya_ilmiah_jenis_karya_ref', array('karya_ilmiah_jenis_karya_ref', $arrjeniskarya, $return['input']['jenis_karya_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'karya_ilmiah_jenis_penelitian_ref', array('karya_ilmiah_jenis_penelitian_ref', $arrjenispenelitian, $return['input']['jenis_penelitian_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'karya_ilmiah_asal_dana_ref', array('karya_ilmiah_asal_dana_ref', $arrasaldana, $return['input']['asal_dana_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'karya_ilmiah_peranan_ref', array('karya_ilmiah_peranan_ref', $arrperanan, $return['input']['peranan_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
         #} else
         #if ($tipe==4){
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'publikasi_jenis_publikasi_ref', array('publikasi_jenis_publikasi_ref', $arrjenispublikasi, $return['input']['jenis_publikasi_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
            Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'publikasi_peranan_ref', array('publikasi_peranan_ref', $arrperanan, $return['input']['peranan_id'], '', ' style="width:200px;" '), Messenger::CurrentRequest);
         #}
      ...
      if($data['lang'] = 'eng'){
        $this->mrTemplate->AddVar('content', 'TITLE', 'MUTASI PENELITIAN / KARYA ILMIAH');
      ...
      $this->mrTemplate->AddVar('content', 'URL_ITSELF', Dispatcher::Instance()->GetUrl('mutasi_penelitian', 'mutasiPenelitian', 'view', 'html') . '&id='.$data['pegId']);
      
      //$this->mrTemplate->AddVar('content', 'URL_ITSELF', Dispatcher::Instance()->GetUrl('mutasi_penelitian', 'reloadMutasiPenelitian', 'do', 'html'));
      ...
      if($data['lang'] = 'eng'){
        $label = "Research & Scientific Papers Mutation Data Management";
      } else {
        $label = "Manajemen Data Mutasi Penelitian & Jurnal Penelitian";
      }
      ...
      if($i == sizeof($dataIstri)-1) $this->mrTemplate->AddVar('content', 'LAST_NUMBER', $no);
         ...
         if ($tipeId==1){
            ...
            $dataPend[$i]['jkaryalabel']='Karya Ilmiah';
         ...
         $dataPend[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('mutasi_penelitian','MutasiPenelitian', 'view', 'html').'&id='.$dataPegawai[0]['id'].'&tipe='. $tipeId.'&dataId='. $idEnc;
