...
'module/mutasi_pelatihan/business/mutasi_pelatihan.class.php';
   ...
   class ViewDetailMutasi extends HtmlResponse
   {
      ...
      function ProcessRequest()
      {
         ...
         $return['link']['url_back'] = Dispatcher::Instance()->GetUrl('mutasi_pelatihan','MutasiPelatihan','view','html').'&id='.$profilId;
      ...
      function ParseTemplate($data = NULL)
      {
         ...
         if($data['lang'] = 'eng'){
           $this->mrTemplate->AddVar('content', 'TITLE', 'EDUCATION & TRAINING DETAIL');
         } else {
           $this->mrTemplate->AddVar('content', 'TITLE', 'DETAIL PENDIDIDKAN & PELATIHAN');
         }
