...
class ViewDetailSertifikasi extends XlsResponse{
	...
	function ProcessRequest(){
		...
		if ($srtfkId!=''){
			...
			$this->datalist['srtfkPeserta'] = $Obj->GetListPesertaSertifikasiByIdDetail($srtfkId,$srtfkdetHasilAkhir,$_GET['source']);
		}
		...
		if ($_GET['source']=='penilaian'){
			//Set Header
			$header[0]=array('No.','NIP/NIK','NIDN','Nama','L/P','Jabatan Akademik','Pangkat','Alamat','Kontak','Tempat dan Tangal Lahir','Institusi','','Bidang Ilmu','','TMMD','Pendidikan','','','No Peserta','No Sertifikasi','Penilaian','','','','','','Asesor','');
			$header[1]=array('','','','','','','','','','','Kode','Nama','Kode','Nama','','S1','S2','S3','','','Persep','Person','Gab PAK','Konst','Hasil Akhir','ATDL','Asesor I','Asesor II');
		...
		}elseif ($_GET['source']=='verifikasi'){
			//Set Header
			$header[0]=array('No.','No Peserta','NIP/NIK','NIDN','Nama','L/P','Jabatan Akademik','Pangkat','Alamat','Kontak','Tempat dan Tangal Lahir','Institusi','','Bidang Ilmu','','TMMD','Pendidikan','','');
			$header[1]=array('','','','','','','','','','','','Kode','Nama','Kode','Nama','','S1','S2','S3');
			//Set Nama Variabel Yang akan ditulis
			$val=array(
						'no',
						'srtfkdetNoPeserta',
		...
		}elseif ($_GET['source']=='usulan'){
			//Set Header
			$header[0]=array('No.','NIP/NIK','NIDN','Nama','L/P','Jabatan Akademik','Pangkat','Alamat','Kontak','Tempat dan Tangal Lahir','Institusi','','Bidang Ilmu','','TMMD','Pendidikan','','');
			$header[1]=array('','','','','','','','','','','Kode','Nama','Kode','Nama','','S1','S2','S3');
			//Set Nama Variabel Yang akan ditulis
			$val=array(
						'no',
		...
		if ($_GET['source']=='penilaian'){
			if ($_GET['srtfkId']!='ALL'){
				$row++;
				$this->mWorksheets['Daftar']->write($row, 0, strtoupper('DAFTAR DOSEN BERSERTIFIKASI TAHUN '.$this->data['srtfkTahun']), $this->fH1);
				...
				$row++;
				$this->mWorksheets['Daftar']->write($row, 0, strtoupper('DAFTAR DOSEN BERSERTIFIKASI KESELURUHAN'), $this->fH1);
				$this->mWorksheets['Daftar']->merge_cells($row, 0, $row,$jumKolom-1);
			}
		}elseif ($_GET['source']=='verifikasi'){
			if ($_GET['srtfkId']!='ALL'){
				$row++;
				$this->mWorksheets['Daftar']->write($row, 0, strtoupper('DAFTAR PESERTA SERTIFIKASI TAHUN '.$this->data['srtfkTahun']), $this->fH1);
				$this->mWorksheets['Daftar']->merge_cells($row, 0, $row,$jumKolom-1);
				$row++;
				$this->mWorksheets['Daftar']->write($row, 0, strtoupper($this->data['srtfkPeriodeAwal_label'].' s/d '.$this->data['srtfkPeriodeAkhir_label']), $this->fH1);
				$this->mWorksheets['Daftar']->merge_cells($row, 0, $row,$jumKolom-1);
				...
				$row++;
				$this->mWorksheets['Daftar']->write($row, 0, strtoupper('DAFTAR PESERTA SERTIFIKASI KESELURUHAN'), $this->fH1);
				$this->mWorksheets['Daftar']->merge_cells($row, 0, $row,$jumKolom-1);
			}
		}elseif ($_GET['source']=='usulan'){
			if ($_GET['srtfkId']!='ALL'){
				$row++;
				$this->mWorksheets['Daftar']->write($row, 0, strtoupper('DAFTAR USULAN PESERTA SERTIFIKASI TAHUN '.$this->data['srtfkTahun']), $this->fH1);
				$this->mWorksheets['Daftar']->merge_cells($row, 0, $row,$jumKolom-1);
				$row++;
				$this->mWorksheets['Daftar']->write($row, 0, strtoupper($this->data['srtfkPeriodeAwal_label'].' s/d '.$this->data['srtfkPeriodeAkhir_label']), $this->fH1);
				$this->mWorksheets['Daftar']->merge_cells($row, 0, $row,$jumKolom-1);
				...
				$row++;
				$this->mWorksheets['Daftar']->write($row, 0, strtoupper('DAFTAR USULAN PESERTA SERTIFIKASI KESELURUHAN'), $this->fH1);
				$this->mWorksheets['Daftar']->merge_cells($row, 0, $row,$jumKolom-1);
			}
		}
