...
class Laporan extends Database {
   ...
   protected $mSqlFile= 'module/laporan_dp3/business/laporan.sql.php';
...
//==GET== 
   ...
   function GetCountDataDp3($awal, $akhir, $unit_kerja, $pangkat_golongan) {
      $sql=$this->mSqlQueries['get_data_dp3']; 
   ...
   function GetDataDp3($offset, $limit, $awal, $akhir, $unit_kerja, $pangkat_golongan) {
      $sql=$this->mSqlQueries['get_data_dp3']; 
