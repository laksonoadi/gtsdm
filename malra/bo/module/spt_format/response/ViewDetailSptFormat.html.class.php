...
class ViewDetailSptFormat extends HtmlResponse {
	public function ProcessRequest(){
		...
		if(!empty($id)){
			$data = $obj->getById($id);
			if(!empty($data)){
				header('Content-type: ' . $this->getMimeType($data['ext']));
				header('Content-Length: ' . strlen($data['file']));
				$this->setHeader($data['keterangan'] . '.' . $data['ext']);
				echo $data['file'];
			}else{
				header('Content-type: ' . $this->getMimeType());
				$this->setHeader('blank');
			}
		}else{
			header('Content-type: ' . $this->getMimeType());
			$this->setHeader('blank');
