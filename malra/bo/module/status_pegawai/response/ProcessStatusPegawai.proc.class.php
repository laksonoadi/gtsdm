...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new StatusPegawai;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('status_pegawai', 'StatusPegawai', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('status_pegawai', 'StatusPegawai', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('status_pegawai', 'StatusPegawai', 'view', 'html', $msg, Messenger::NextRequest);
