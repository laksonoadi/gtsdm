...
class Process{
  ...
  function __construct() {
    ...
    $this->pageView = Dispatcher::Instance()->GetUrl('periode_cuti', 'periodeCuti', 'view', 'html') . '&pegId=' . $this->pegId;
    $this->pageBack = Dispatcher::Instance()->GetUrl('data_cuti', 'historyDataCuti', 'view', 'html') . '&dataId=' . $this->pegId;
    $this->pageInput = Dispatcher::Instance()->GetUrl('periode_cuti', 'periodeCuti', 'view', 'html');
  ...
  function Check (){
    ...
    if (isset($error)){
      ...
      Messenger::Instance()->Send('periode_cuti', 'periodeCuti', 'view', 'html', $msg, Messenger::NextRequest);
