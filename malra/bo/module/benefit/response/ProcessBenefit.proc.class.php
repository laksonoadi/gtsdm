...
class Process{
  ...
  function __construct() {
    ...
    $this->pageView = Dispatcher::Instance()->GetUrl('benefit', 'benefit', 'view', 'html');
    $this->pageInput = Dispatcher::Instance()->GetUrl('benefit', 'benefit', 'view', 'html');
  ...
  function Check (){
    ...
    if (isset($error)){
      ...
      Messenger::Instance()->Send('benefit', 'benefit', 'view', 'html', $msg, Messenger::NextRequest);
  ...
  function Update(){
    ...
    $data=array('nama'=>$this->_POST['nama'],'uraian'=>$this->_POST['uraian'],'pengecualian'=>$this->_POST['pengecualian'],'tgl'=>$tgl,'id'=>$this->decId);
  ...
  function Add(){
    ...
    $tgl=$this->_POST['tgl_year'].'-'.$this->_POST['tgl_mon'].'-'.$this->_POST['tgl_day'];
    $data=array('nama'=>$this->_POST['nama'],'uraian'=>$this->_POST['uraian'],'pengecualian'=>$this->_POST['pengecualian'],'tgl'=>$tgl);//print_r($data);
