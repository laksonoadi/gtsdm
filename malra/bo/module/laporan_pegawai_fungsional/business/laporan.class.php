...
class Laporan extends Database {
   ...
   protected $mSqlFile= 'module/laporan_pegawai_fungsional/business/laporan.sql.php';
...
//==GET== 
   ...
   function GetComboFungsional($jenis){
      $result=$this->Open($this->mSqlQueries['get_combo_fungsional'],array($jenis));
      $i=sizeof($result);
      $result[$i]['id']=99999;
      $result[$i]['name']='Belum Diset';
      return $result;
