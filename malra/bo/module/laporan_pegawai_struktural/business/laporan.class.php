...
class Laporan extends Database {
   ...
   protected $mSqlFile= 'module/laporan_pegawai_struktural/business/laporan.sql.php';
...
//==GET== 
   ...
   function GetComboStruktural(){
      $result=$this->Open($this->mSqlQueries['get_combo_struktural'],array());
      //$i=sizeof($result);
      //$result[$i]['id']=99999;
      //$result[$i]['name']='Belum Diset';
   ...
   function GetComboJabatanStruktural(){
      return $this->Open($this->mSqlQueries['get_combo_jabatan_struktural'],array());
   }
   
   function GetDataPegawai($offset, $limit,$jenis_pegawai) {
