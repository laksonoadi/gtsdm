...
class Laporan extends Database {
   ...
   protected $mSqlFile= 'module/laporan_kenaikanpangkat/business/laporan.sql.php';
...
//==GET== 
   ...
   function GetCountDataKenaikanPangkat($awal, $akhir, $unit_kerja, $pangkat_golongan) {
      $sql=$this->mSqlQueries['get_data_kenaikanpangkat']; 
      // $list=$this->Obj->GetListIdAnakUnitByUnitId($unit_kerja);
      if($unit_kerja != "all"){
  		  $sql=str_replace('%unit_kerja%',' AND (satkerId = '.$unit_kerja.' OR satkerLevel LIKE "'.$unit_kerja.'.%%")' ,$sql);
      }else{
   ...
   function GetDataKenaikanPangkat($offset, $limit, $awal, $akhir, $unit_kerja, $pangkat_golongan) {
      $sql=$this->mSqlQueries['get_data_kenaikanpangkat']; 
      // $list=$this->Obj->GetListIdAnakUnitByUnitId($unit_kerja);
      if($unit_kerja != "all"){
  		  $sql=str_replace('%unit_kerja%',' AND (satkerId = '.$unit_kerja.' OR satkerLevel LIKE "'.$unit_kerja.'.%%")' ,$sql);
