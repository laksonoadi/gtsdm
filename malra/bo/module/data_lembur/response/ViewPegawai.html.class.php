...
class ViewPegawai extends HtmlResponse
{
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('data_lembur', 'pegawai', 'view', 'html') );
      ...
      if (empty($data['dataPegawai'])) {
        ...
        $total=0;
          ...
          $dataPegawai[$i]['URL_DETAIL'] = Dispatcher::Instance()->GetUrl('data_lembur','dataLembur', 'view', 'html').'&dataId='. $idEnc;
          $dataPegawai[$i]['URL_HISTORY'] = Dispatcher::Instance()->GetUrl('data_lembur','historyDataLembur', 'view', 'html').'&dataId='. $idEnc;
