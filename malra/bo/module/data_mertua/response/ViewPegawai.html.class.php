...
class ViewPegawai extends HtmlResponse
{
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('data_mertua', 'pegawai', 'view', 'html') );
      ...
      if (empty($data['dataPegawai'])) {
        ...
        $total=0;
          ...
          $dataPegawai[$i]['URL_DETAIL'] = Dispatcher::Instance()->GetUrl('data_mertua','dataMertua', 'view', 'html').'&dataId='. $idEnc;
