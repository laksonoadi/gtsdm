...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new JenisKunjunganLn;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('jenis_kunjungan_ln', 'JenisKunjunganLn', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('jenis_kunjungan_ln', 'JenisKunjunganLn', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('jenis_kunjungan_ln', 'JenisKunjunganLn', 'view', 'html', $msg, Messenger::NextRequest);
