...
class ViewMutasiPendidikan extends HtmlResponse{
    ...
    function ProcessRequest() {
        ...
        if(isset($_GET['id'])){
            ...
            if(isset($_GET['dataId'])){
				...
				if(!empty($result)){
                    ...
                    $return['input']['no_ijazah'] = $result['no_ijazah'];
        ...
        Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'jenispend', array('jenispend', $arrjp, $return['input']['jpendid'], 'false', ' style="width:200px;" '), Messenger::CurrentRequest);
        Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'negara', array('negara', $arrneg, $return['input']['negid'], '', ' style="width:500px;" '), Messenger::CurrentRequest);
	    ...
	    Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'istamat', array('istamat', $list_istamat, $return['input']['istamat'], '', 'id="istamat" style="width:200px;"  '), Messenger::CurrentRequest);
	    ...
	    Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'lama', array('lama', $list_lama, $return['input']['lama'], '', 'id="lama "   style="width:60px;" '), Messenger::CurrentRequest);
    ...
    function ParseTemplate($data = NULL){
		...
		if($data['lang'] = "eng"){
			$this->mrTemplate->AddVar('content', 'TITLE', 'PENDIDIKAN FORMAL');
