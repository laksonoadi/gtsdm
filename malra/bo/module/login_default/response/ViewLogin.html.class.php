...
class ViewLogin extends HtmlResponse {
   ...
   function ParseTemplate($data = NULL) {
      ...
      $this->mrTemplate->AddVar('content', 'COMPANY_NAME', GTFWConfiguration::GetValue('organization', 'company_name'));
      $this->mrTemplate->AddVar('content', 'APPLICATION_NAME', GTFWConfiguration::GetValue('organization','application_name'));
