...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new JenisHukuman;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('jenis_hukuman', 'JenisHukuman', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('jenis_hukuman', 'JenisHukuman', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('jenis_hukuman', 'JenisHukuman', 'view', 'html', $msg, Messenger::NextRequest);
