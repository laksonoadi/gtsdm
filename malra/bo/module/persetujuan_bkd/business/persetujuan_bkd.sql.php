...
UPDATE sdm_bkd_pendidikan
SET
	bkdpendRekomendasi = %s
WHERE
	bkdpendId = %s
";
// PENDIDIKAN -----------------------------------------------------------------------------------------------------------------------------------
...
UPDATE sdm_bkd_pengabdian
SET
	bkdpengRekomendasi = %s
WHERE
	bkdpengId = %s
";
// PENGABDIAN -----------------------------------------------------------------------------------------------------------------------------------
...
UPDATE sdm_bkd_penunjang
SET
	bkdpenuRekomendasi = %s
WHERE
	bkdpenuId = %s
";
// PENUNJANG -----------------------------------------------------------------------------------------------------------------------------------
...
// PROFESOR -----------------------------------------------------------------------------------------------------------------------------------
$sql['do_add_profesor'] = "
UPDATE sdm_bkd_profesor
SET
	bkdprofRekomendasi = %s
WHERE
	bkdprofId = %s
";
// PROFESOR -----------------------------------------------------------------------------------------------------------------------------------
