...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='PERSETUJUAN BEBAN KINERJA DOSEN';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'PersetujuanBkd',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
