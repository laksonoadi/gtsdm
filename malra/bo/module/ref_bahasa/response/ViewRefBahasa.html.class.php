...
require_once GTFWConfiguration::GetValue( 'application', 'docroot').
   'module/ref_bahasa/business/RefBahasa.class.php';
   
class ViewRefBahasa extends HtmlResponse{
	public function TemplateModule(){
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
		'module/ref_bahasa/'.GTFWConfiguration::GetValue('application', 'template_address').'');
		$this->SetTemplateFile('view_ref_bahasa.html');
	}
	...
	public function ProcessRequest(){
		...
		// links
		$this->title = 'Referensi Bahasa';
		$this->listUrl = Dispatcher::Instance()->GetUrl('ref_bahasa','refBahasa','view','html');
		$this->inputUrl = Dispatcher::Instance()->GetUrl('ref_bahasa','inputRefBahasa','view','html');
		$this->detailUrl = Dispatcher::Instance()->GetUrl('ref_bahasa','detailRefBahasa','view','html');
		$this->doDeleteUrl = Dispatcher::Instance()->GetUrl('ref_bahasa', 'deleteRefBahasa', 'do', 'html');
		$this->deleteUrl = Dispatcher::Instance()->GetUrl('confirm', 'confirmDelete', 'do', 'html').
		"&urlDelete=".Dispatcher::Instance()->Encrypt('ref_bahasa|deleteRefBahasa|do|html').
		"&urlReturn=".Dispatcher::Instance()->Encrypt('ref_bahasa|refBahasa|view|html').
