...
class ViewInputRefBahasa extends HtmlResponse {
   
	public function TemplateModule(){
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').'module/ref_bahasa/'.GTFWConfiguration::GetValue('application', 'template_address').'/');
		$this->SetTemplateFile('input_ref_bahasa.html');    
	} 
	...
	public function ProcessRequest(){
		...
		$this->inputUrl = Dispatcher::Instance()->GetUrl('ref_bahasa','inputRefBahasa','do','html');
