...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='RIWAYAT PENGABDIAN MASYARAKAT';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiPengabdian',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
