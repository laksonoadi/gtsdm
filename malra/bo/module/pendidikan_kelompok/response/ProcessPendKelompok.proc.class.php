...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new PendidikanKelompok;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('pendidikan_kelompok', 'pendKelompok', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('pendidikan_kelompok', 'pendKelompok', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('pendidikan_kelompok', 'pendKelompok', 'view', 'html', $msg, Messenger::NextRequest);
