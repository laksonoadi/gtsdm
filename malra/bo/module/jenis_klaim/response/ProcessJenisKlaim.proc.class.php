...
class Process{
  ...
  function __construct() {
    $this->Obj = new JenisKlaim;
    $this->_POST = $_REQUEST->AsArray();
    $this->decId = $_GET['id']->Integer()->Raw();
    $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
    $this->encId = $this->decId;
    $this->pageView = Dispatcher::Instance()->GetUrl('jenis_klaim', 'jenisKlaim', 'view', 'html');
    $this->pageInput = Dispatcher::Instance()->GetUrl('jenis_klaim', 'jenisKlaim', 'view', 'html');
  ...
  function Check (){
    ...
    if (isset($error)){
      ...
      Messenger::Instance()->Send('jenis_klaim', 'jenisKlaim', 'view', 'html', $msg, Messenger::NextRequest);
