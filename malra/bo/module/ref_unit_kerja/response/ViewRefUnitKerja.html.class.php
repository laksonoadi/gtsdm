...
class ViewRefUnitKerja extends HtmlResponse{
	public function TemplateModule(){
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').
		'module/ref_unit_kerja/'.GTFWConfiguration::GetValue('application', 'template_address').'');
		$this->SetTemplateFile('view_ref_unit_kerja.html');
	}
   
	public function ProcessRequest(){
		$obj = new RefUnitKerja;
		...
		// links
		$this->title = 'Referensi Unit Kerja';
		$this->listUrl = Dispatcher::Instance()->GetUrl('ref_unit_kerja','refUnitKerja','view','html');
		$this->inputUrl = Dispatcher::Instance()->GetUrl('ref_unit_kerja','inputRefUnitKerja','view','html');
		$this->detailUrl = Dispatcher::Instance()->GetUrl('ref_unit_kerja','detailRefUnitKerja','view','html');
		$this->doDeleteUrl = Dispatcher::Instance()->GetUrl('ref_unit_kerja', 'deleteRefUnitKerja', 'do', 'html');
		$this->deleteUrl = Dispatcher::Instance()->GetUrl('confirm', 'confirmDelete', 'do', 'html').
		"&urlDelete=".Dispatcher::Instance()->Encrypt('ref_unit_kerja|deleteRefUnitKerja|do|html').
		"&urlReturn=".Dispatcher::Instance()->Encrypt('ref_unit_kerja|refUnitKerja|view|html').
