...
class ViewInputRefUnitKerja extends HtmlResponse {
   
	public function TemplateModule(){
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').'module/ref_unit_kerja/'.GTFWConfiguration::GetValue('application', 'template_address').'/');
		$this->SetTemplateFile('input_ref_unit_kerja.html');    
	} 
	...
	public function ProcessRequest(){
		...
		$this->inputUrl = Dispatcher::Instance()->GetUrl('ref_unit_kerja','inputRefUnitKerja','do','html');
