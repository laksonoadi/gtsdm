...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new JenisKarya;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('jenis_karya', 'JenisKarya', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('jenis_karya', 'JenisKarya', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('jenis_karya', 'JenisKarya', 'view', 'html', $msg, Messenger::NextRequest);
