...
class ViewComboJabatanFungsional extends HtmlResponse
{
    ...
    function ProcessRequest() {
        ...
        Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'jenis_jabatan', array('ref_jab', $jabatanlist, '', 'false', ' style="width:500px;" '), Messenger::CurrentRequest);
