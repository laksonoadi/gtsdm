...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='MUTASI JABATAN FUNGSIONAL';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'JabatanFungsional',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
