...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new BidangKepakaran;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('bidang_kepakaran', 'BidangKepakaran', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('bidang_kepakaran', 'BidangKepakaran', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('bidang_kepakaran', 'BidangKepakaran', 'view', 'html', $msg, Messenger::NextRequest);
   ...
   function Update()
   {
	  ...
	  $data=array('bidId'=>$this->_POST['bidang'],'nama'=>$this->_POST['nama'],'id'=>$this->decId);
   ...
   function Add()
   {
     $check = $this->Check();
	  ...
	  $data=array('bidId'=>$this->_POST['bidang'],'nama'=>$this->_POST['nama']);//print_r($data);
