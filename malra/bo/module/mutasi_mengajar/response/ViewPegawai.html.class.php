...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiMengajar',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
