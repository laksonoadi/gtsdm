...
class ViewMutasiBintangTandaJasa extends HtmlResponse
   {
      ...
      $arrjp = $peng->GetComboTandaJasa();
            ...
            if(isset($_GET['dataId'])){
               ...
               $result=$dataMutasi[0]; 
                  if(!empty($result)){
                     ...
                     $return['input']['tanda_jasa_nama'] = $result['tanda_jasa_nama'];
        ...
        $return['input']['tanda_jasa_nama'] ='';
				...
				$return['input']['upload'] = '';
				$return['input']['tanggal'] = date("Y-m-d");
				$return['input']['sk_tahun'] = date("Y");
     ...
     //    Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'tanda_jasa_id', array('tanda_jasa_id', $arrjp, $return['input']['tanda_jasa_id'], 'false', ' style="width:100px;" '), Messenger::CurrentRequest);
      ...
      //print_r($dataPeng);
      if ($data['lang']='eng'){
        $this->mrTemplate->AddVar('content', 'TITLE', 'TANDA JASA');
