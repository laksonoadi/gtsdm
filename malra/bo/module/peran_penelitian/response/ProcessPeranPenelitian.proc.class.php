...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new PeranPenelitian;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('peran_penelitian', 'PeranPenelitian', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('peran_penelitian', 'PeranPenelitian', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('peran_penelitian', 'PeranPenelitian', 'view', 'html', $msg, Messenger::NextRequest);
