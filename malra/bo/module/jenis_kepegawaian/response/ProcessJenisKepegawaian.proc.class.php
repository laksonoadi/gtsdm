...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new JenisKepegawaian;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('jenis_kepegawaian', 'JenisKepegawaian', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('jenis_kepegawaian', 'JenisKepegawaian', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('jenis_kepegawaian', 'JenisKepegawaian', 'view', 'html', $msg, Messenger::NextRequest);
   ...
   function Add()
   {
     $check = $this->Check();
	  ...
	  $data=array('nama'=>$this->_POST['nama']);//print_r($data);exit;
