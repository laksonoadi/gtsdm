...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new JenisJabatanFungsional;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('jenis_jabatan_fungsional','JenisJabatanFungsional','view','html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('jenis_jabatan_fungsional','JenisJabatanFungsional','view','html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('jenis_jabatan_fungsional','JenisJabatanFungsional','view','html', $msg, Messenger::NextRequest);
   ...
   function Update()
   {
	  ...
	  $data=array('nama'=>$this->_POST['nama'],'id'=>$this->decId);
   ...
   function Add()
   {
     $check = $this->Check();
	  ...
	  $data=array('nama'=>$this->_POST['nama']);
