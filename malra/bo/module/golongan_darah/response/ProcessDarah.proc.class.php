...
class Process
{
   var $_POST;
	...
	function __construct() {
	   ...
	   $this->pageView = Dispatcher::Instance()->GetUrl('golongan_darah','darah','view','html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('golongan_darah','darah','view','html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('golongan_darah','darah','view','html', $msg, Messenger::NextRequest);
