...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='RIWAYAT KUNJUNGAN LUAR NEGERI';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiKunjungan',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
