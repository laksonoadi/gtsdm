...
class Laporan extends Database {
   ...
   protected $mSqlFile= 'module/laporan_cuti_per_pegawai/business/laporan.sql.php';
...
//==GET== 
   function GetComboNip(){
      return $this->Open($this->mSqlQueries['get_combo_nip'],array());
   }
   
   function GetCountDataCuti($cuti) {
    return $this->Open($this->mSqlQueries['get_count_data_cuti'],array($cuti));  
	//print_r($this->getLastError());exit;
   }
   
   function GetDataCuti($offset, $limit, $Cuti) {
    return $this->Open($this->mSqlQueries['get_data_cuti'],array($Cuti,$offset, $limit));
	print_r($this->getLastError());exit;
   }
   function GetDataCutiXls($Cuti) {
    return $this->Open($this->mSqlQueries['get_data_cuti_xls'],array($Cuti));
	//print_r($this->getLastError());exit;
   }
