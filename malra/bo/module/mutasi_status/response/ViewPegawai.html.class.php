...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='MUTASI KEDUDUKAN HUKUM PEGAWAI';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiStatus',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
