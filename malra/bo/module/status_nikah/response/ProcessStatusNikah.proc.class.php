...
class Process
{
   var $_POST;
	...
	function __construct() {
	   ...
	   $this->pageView = Dispatcher::Instance()->GetUrl('status_nikah','statusNikah','view','html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('status_nikah','statusNikah','view','html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('status_nikah','statusNikah','view','html', $msg, Messenger::NextRequest);
