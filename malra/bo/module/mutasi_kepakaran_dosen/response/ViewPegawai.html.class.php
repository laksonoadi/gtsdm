...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiKepakaranDosen',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
