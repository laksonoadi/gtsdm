...
class Process
{
   var $_POST;
	...
	function __construct() {
	   ...
	   $this->pageView = Dispatcher::Instance()->GetUrl('warga_negara','wargaNegara','view','html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('warga_negara','wargaNegara','view','html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('warga_negara','wargaNegara','view','html', $msg, Messenger::NextRequest);
   ...
   function Update()
   {
	  ...
	  $data=array('kode'=>$this->_POST['kode'],'nama'=>$this->_POST['nama'],'userId'=>$this->user,'id'=>$this->decId);
   ...
   function Add()
   {
     $check = $this->Check();
	  ...
	  $data=array('kode'=>$this->_POST['kode'],'nama'=>$this->_POST['nama'],'userId'=>$this->user);//print_r($data);
