...
class Warga extends Database {
   ...
   protected $mSqlFile= 'module/warga_negara/business/warga.sql.php';
...
//==GET==      
   ...
   function Add($data) {	   
      $return = $this->Execute($this->mSqlQueries['do_add'], array($data['kode'],$data['nama'],$data['userId']));	  
      return $return;
   }  
	
   function Update($data) {
     $return = $this->Execute($this->mSqlQueries['do_update'], array($data['kode'],$data['nama'],$data['userId'], $data['id']));         		  
		//$this->mdebug();  
      return $return;
   }   
