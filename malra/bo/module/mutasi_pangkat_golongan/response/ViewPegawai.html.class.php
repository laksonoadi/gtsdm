...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiPangkatGolongan',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
