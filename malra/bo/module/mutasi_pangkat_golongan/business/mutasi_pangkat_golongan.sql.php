...
SELECT 
	...
	p.pktgolTmt as tmt,
	p.pktgolMsThn as masa_thn,
	p.pktgolMsBln as masa_bln,
	p.pktgolPejabatSk as pejabat,
	p.pktgolNoSk as nosk,
	p.pktgolTglSk as tgl_sk,
	p.pktgolDsrPeraturan as dasar,
	p.pktgolTglBkn as tgl_bkn,
	p.pktgolGaji as gaji_pangkat,
...
WHERE 
   p.pktgolPegKode='%s'
ORDER BY p.pktgolTmt DESC, p.pktgolId DESC
"; 
...
INSERT INTO 
   sdm_pangkat_golongan
   (pktgolPegKode,pktgolJnspegrId,pktgolPktgolrId,pktgolTmt,pktgolMsThn,pktgolMsBln,pktgolNaikPktYad,
   pktgolPejabatSk,pktgolNoSk,pktgolTglSk,pktgolDsrPeraturan,pktgolTglBkn,pktgolGaji,pktgolStatus,pktgolSkUpload)
...
$sql['get_last_mutasi_golongan_pegawai']="
SELECT 
	p.pktgolId as id,
	p.pktgolPegKode as nip,
	p.pktgolPktgolrId as golongan
