...
class ViewLayananPangkatFungsional extends HtmlResponse
{
   function TemplateModule()
   {
      ...
      $this->SetTemplateFile('view_layanan_pangkat_fungsional.html');
   }
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('layanan_pangkat_fungsional', 'layananPangkatFungsional', 'view', 'html') );
        ...
        if (empty($data['dataPegawai'])) {
    			...
    			for ($i=0; $i<sizeof($dataPegawai); $i++) {
                    ...
                    $dataPegawai[$i]['url_input'] = Dispatcher::Instance()->GetUrl('layanan_pangkat_fungsional', 'inputLayananPangkatFungsional', 'view', 'html').'&id='.$dataPegawai[$i]['id_pangkat'];
