...
class ViewInputLayananPangkatFungsional extends HtmlResponse {
   
	public function TemplateModule(){
		$this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').'module/layanan_pangkat_fungsional/'.GTFWConfiguration::GetValue('application', 'template_address').'/');
		$this->SetTemplateFile('input_layanan_pangkat_fungsional.html');    
	} 
	...
	public function ProcessRequest(){
        ...
        $this->title = 'Layanan Kenaikan Pangkat Fungsional';

		// links
		$this->listUrl = Dispatcher::Instance()->GetUrl('layanan_pangkat_fungsional','LayananPangkatFungsional','view','html');
		$this->inputUrl = Dispatcher::Instance()->GetUrl('layanan_pangkat_fungsional','inputLayananPangkatFungsional','do','html');
		$this->deleteUrl = Dispatcher::Instance()->GetUrl('confirm', 'confirmDelete', 'do', 'html').
		"&urlDelete=".Dispatcher::Instance()->Encrypt('layanan_pangkat_fungsional|deleteLayananPangkatFungsional|do|html').
		"&urlReturn=".Dispatcher::Instance()->Encrypt('layanan_pangkat_fungsional|LayananPangkatFungsional|view|html').
	...
	public function ParseTemplate ($data = NULL){
        ...
        $this->mrTemplate->addVar('content', 'URL_ACTION', Dispatcher::Instance()->GetUrl('layanan_pangkat_fungsional', 'inputLayananPangkatFungsional', 'do', 'html'));
        ...
        if(isset($data['input']['id'])) {
            ...
            $this->mrTemplate->addVar('button_cetak', 'URL_RTF', Dispatcher::Instance()->GetUrl('layanan_pangkat_fungsional', 'RtfLayananPangkatFungsional', 'view', 'html').'&id='.$data['input']['id']);
            $pegawai = $data['input'];
        } else {
