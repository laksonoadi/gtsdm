...
class Process
{
   ...
   function __construct($ret) {
	  ...
	  if($ret == "html"){
		$this->pageInput = Dispatcher::Instance()->GetUrl('mutasi_seminar','MutasiSeminar','view','html').'&id='.$this->profilId;
		$this->pageView = Dispatcher::Instance()->GetUrl('mutasi_seminar','MutasiSeminar','view','html').'&id='.$this->profilId;
		$this->pageBack = Dispatcher::Instance()->GetUrl('mutasi_seminar','MutasiSeminar','view','html').'&id='.$this->delId;
	  }else{
		$this->pageInput = Dispatcher::Instance()->GetUrl('mutasi_seminar','MutasiSeminar','view','html',true).'&id='.$this->profilId;
		$this->pageView = Dispatcher::Instance()->GetUrl('mutasi_seminar','MutasiSeminar','view','html',true).'&id='.$this->profilId;
		$this->pageBack = Dispatcher::Instance()->GetUrl('mutasi_seminar','MutasiSeminar','view','html').'&id='.$this->delId;
      }
  ...
  function Check (){
    ...
    if (isset($error)){
      ...
      Messenger::Instance()->Send('mutasi_seminar','MutasiSeminar','view','html', $msg, Messenger::NextRequest);
  ...
  function AddData($nama_file){
      ...
      $array=array(
                  ...
                  'nama'=>$this->POST['nama'],
                  'tingkatid'=>$this->POST['tingkat'],
                  'peranan'=>$this->POST['peranan'],
                  'mulai'=>$mulai,
      ...
      $result = $this->Obj->Add($array);
         if ($result){
			return $result;
            #Messenger::Instance()->Send('mutasi_seminar','MutasiSeminar','view','html', array($this->POST,$this->msgAddSuccess,$this->cssDone),Messenger::NextRequest);
         }else{
			return false;
            #Messenger::Instance()->Send('mutasi_seminar','MutasiSeminar','view','html', array($this->POST,$this->msgAddFail,$this->cssFail),Messenger::NextRequest);
         }
	...
	function UpdateData($nama_file){
      ...
      $result = $this->Obj->Update($array);
         if ($result){
			return $result;
            #Messenger::Instance()->Send('mutasi_seminar','MutasiSeminar','view','html', array($this->POST,$this->msgUpdateSuccess,$this->cssDone),Messenger::NextRequest);
         }else{
			return false;
            #Messenger::Instance()->Send('mutasi_seminar','MutasiSeminar','view','html', array($this->POST,$this->msgUpdateFail,$this->cssFail),Messenger::NextRequest);
         }
      return $this->pageView;
  }
   ...
   if($deleteData == true) {
			Messenger::Instance()->Send('mutasi_seminar', 'MutasiSeminar', 'view', 'html', array($this->POST,$this->msgDeleteSuccess, $this->cssDone),Messenger::NextRequest);   
		}else{
			Messenger::Instance()->Send('mutasi_seminar', 'MutasiSeminar', 'view', 'html', array($this->POST,$this->msgDeleteFail, $this->cssFail),Messenger::NextRequest);   
		}
