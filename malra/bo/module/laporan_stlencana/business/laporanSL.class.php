...
class LaporanSL extends Database {

	protected $mSqlFile= 'module/laporan_stlencana/business/laporansl.sql.php';
...
//==GET==    
	...
	function GetDaftarPegawai($startRec="", $itemViewed="") {
		...
		if($this->berdasarkan=='10'){
			$search = 'AND mks BETWEEN 3623 AND 3653';
		}
		if($this->berdasarkan=='20'){
			$search = 'AND mks BETWEEN 7275 AND 7305';
		}
		if($this->berdasarkan=='30'){
			$search = 'AND mks BETWEEN 10928 AND 10958';
		}if($this->berdasarkan=='semua' || $this->berdasarkan =='nama'){
			$search = 'AND (mks BETWEEN 10928 AND 10958) OR (mks BETWEEN 7275 AND 7305) OR (mks BETWEEN 3623 AND 3653)';
		}
