...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new AsalDana;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = Dispatcher::Instance()->Decrypt($_GET['id']);
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('asal_dana', 'asalDana', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('asal_dana', 'asalDana', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('asal_dana', 'asalDana', 'view', 'html', $msg, Messenger::NextRequest);
