...
class ViewRtfLayananPangkatStrategis extends HtmlResponse
{
    ...
    function ProcessRequest()
    {
        ...
        $contents = file_get_contents(GTFWConfiguration::GetValue( 'application', 'docroot')."doc/template_layanan_pangkat_strategis.rtf");
        ...
        $sk['old_jab_id'] = (!empty($sk['id_old_jabstruk']) ? $sk['id_old_jabstruk'] : $sk['id_old_jabfung']);
        $sk['old_jab_nama'] = (!empty($sk['id_old_jabstruk']) ? $sk['old_jabstruk_nama'] : $sk['old_jabfung_nama']);
        $sk['old_jab_tmt'] = (!empty($sk['id_old_jabstruk']) ? $sk['old_jabstruk_tmt'] : $sk['old_jabfung_tmt']);
        ...
        header("Content-disposition: inline; filename=layanan_pangkat_strategis_".$nama.".rtf");
