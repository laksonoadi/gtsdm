...
class ViewPopupPegawai extends HtmlResponse {
	...
	function TemplateModule() {
		$this->SetTemplateBasedir($this->mrConfig->mApplication['docroot'].'module/mutasi_dp3/'.GTFWConfiguration::GetValue('application', 'template_address').'');
	...
	function ParseTemplate($data = NULL) {
		...
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('mutasi_dp3', 'popupPegawai', 'view', 'html'));
