...
SELECT 
	...
	IF(pegdtKategori='Academic',jabfungrNama,jabstrukrNama) as jabatan_fungsional,
	jabfungrId as diangkat,
	jabfungrNama as diangkat_label,
	IF(pegdtKategori='Academic',c.jbtnTglMulai,d.jbtnTglMulai) as jabatan_fungsional_tmt,
