...
$application['db_conn'][0]['db_pass'] = 'root';
// $application['db_conn'][0]['db_name'] = 'dev_sdm_ma';
// $application['db_conn'][0]['db_host'] = 'localhost';
// $application['db_conn'][0]['db_user'] = 'root';
// $application['db_conn'][0]['db_pass'] = '';
$application['db_conn'][0]['db_name'] = 'dev_sdm_malra';

// $application['db_conn'][0]['db_host'] = 'localhost';
// $application['db_conn'][0]['db_user'] = 'maluku_dev';
// $application['db_conn'][0]['db_pass'] = 'UuK2k1UVXJR';
// $application['db_conn'][0]['db_name'] = 'maluku_dev';
...
$application['company_address'] ="Jl Talaver, Langgur Kabupaten Maluku Tenggara";
$application['company_city'] ="Kabupaten Maluku Tenggara";
$application['application_name'] ="SIMAKEP - Sistem Informasi Kepegawaian";
$application['tahun'] ="2016";
...
$application['template_anjab'] = "upload_file/template_anjab/";
$application['panduan_group_path'] = "upload_file/panduan_group/";


$application['akta_pegawai_path'] = "upload_file/akta_pegawai/";
$application['akta_pasangan_path'] = "upload_file/akta_pasangan/";
$application['akta_anak_path'] = "upload_file/akta_anak/";
$application['akta_ortu_path'] = "upload_file/akta_ortu/";
