...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiBeasiswa',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
