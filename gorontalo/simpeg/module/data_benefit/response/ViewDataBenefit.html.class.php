   ...
   function ProcessRequest()
   {
      if ($_GET['dataId'] != '') {
        ...
        if($resultBenefit){
         ...
         $return['input']['id_benefit'] = $resultBenefit[0]['id_benefit'];
         ...
         $return['input']['total_klaim'] = $resultBenefit[0]['total_klaim'];
      ...
      if($_GET['op'] == 'add'){
        ...
        $jenisBenefit = $Obj->GetComboJenisBenefit();
        Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'jenis_benefit', 
        array('jenis_benefit',$jenisBenefit,$return['input']['id_jnsbenefit'],'false',' style="width:170px;"'), Messenger::CurrentRequest);
        
        //combo jenis klaim
        $jenisKlaim = $Obj->GetComboJenisKlaim();
        Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'jenis_klaim', 
        array('jenis_klaim',$jenisKlaim,$return['input']['id_jnsklaim'],'false',' style="width:170px;"'), Messenger::CurrentRequest);
        ...
        Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'relasi_pasien', 
        array('relasi_pasien',$reduced,$return['input']['relasi_pasien'],'',' style="width:100px;"'), Messenger::CurrentRequest);
