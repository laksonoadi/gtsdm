...
class ViewHistoryDataBenefit extends HtmlResponse {
    ...
    //tampilkan history benefit
        ...
        $dataHistory[$i]['url_delete'] = Dispatcher::Instance()->GetUrl('data_benefit', 'deleteDataBenefit', 'view', 'html') . '&dataId=' . $idEnc;
        if($dataHistory[$i]['status'] == 'approved'){
          ...
          $dataHistory[$i]['url_detail'] = Dispatcher::Instance()->GetUrl('persetujuan_benefit', 'inputAppBenefit', 'view', 'html') . '&dataId=' . $data['idPegawai'] . '&dataId2=' . $idEnc;
          $dataHistory[$i]['url_edit'] = Dispatcher::Instance()->GetUrl('persetujuan_benefit', 'inputAppBenefit', 'view', 'html') . '&dataId=' . $data['idPegawai'] . '&dataId2=' . $idEnc;
        }
