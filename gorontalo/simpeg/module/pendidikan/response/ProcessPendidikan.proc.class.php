...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new Pendidikan;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('pendidikan', 'pendidikan', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('pendidikan', 'pendidikan', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('pendidikan', 'pendidikan', 'view', 'html', $msg, Messenger::NextRequest);
   ...
   function Update()
   {
	  ...
	  $data=array('kelId'=>$this->_POST['kelompok'],'nama'=>$this->_POST['nama'],'userId'=>$this->user,'id'=>$this->decId);
   ...
   function Add()
   {
     $check = $this->Check();
	  ...
	  $data=array('kelId'=>$this->_POST['kelompok'],'nama'=>$this->_POST['nama'],'userId'=>$this->user);//print_r($data);
