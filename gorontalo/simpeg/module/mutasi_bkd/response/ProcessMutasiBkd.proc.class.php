   ...
   function Delete(){
		...
		if($paramBkd == "pendidikan"){
			...
			if($deleteData == true){
				...
				@unlink(GTFWConfiguration::GetValue( 'application', 'docroot').'upload_file/file/'.$nama_filePddk);
			}
			...
			if($deleteData == true){
				...
				@unlink(GTFWConfiguration::GetValue( 'application', 'docroot').'upload_file/file/'.$nama_filePenelt);
			}
			$headerLocate	= $this->pageEndDelete;
			...
			if($deleteData == true){
				...
				@unlink(GTFWConfiguration::GetValue( 'application', 'docroot').'upload_file/file/'.$nama_filePengbd);
			}
			$headerLocate	= $this->pageEndDelete;
			...
			if($deleteData == true){
				...
				@unlink(GTFWConfiguration::GetValue( 'application', 'docroot').'upload_file/file/'.$nama_filePenunj);
			}
			$headerLocate	= $this->pageEndDelete;
			...
			if($deleteData == true){
				...
				@unlink(GTFWConfiguration::GetValue( 'application', 'docroot').'upload_file/file/'.$nama_fileProf);
			}
			$headerLocate	= $this->pageEndDelete;
