...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new TingkatSeminar;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('tingkat_seminar', 'TingkatSeminar', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('tingkat_seminar', 'TingkatSeminar', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('tingkat_seminar', 'TingkatSeminar', 'view', 'html', $msg, Messenger::NextRequest);
