...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='RIWAYAT PENGALAMAN KERJA PEGAWAI';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiPekerjaanPegawai',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
