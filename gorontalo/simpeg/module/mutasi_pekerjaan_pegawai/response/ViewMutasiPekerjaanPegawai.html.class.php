...
class ViewMutasiPekerjaanPegawai extends HtmlResponse
   {
     ...
     // $arrjh = $org->GetComboJenisOrganisasi Pegawai();      
      ...
      $dataName = $dataOrg[$i]['nama'];
         ...
         $dataOrg[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('mutasi_pekerjaan_pegawai','MutasiPekerjaanPegawai', 'view', 'html').'&id='.$dataPegawai[0]['id'].'&dataId='. $idEnc;
