...
class MutasiPekerjaanPegawai extends Database {

   protected $mSqlFile= 'module/mutasi_pekerjaan_pegawai/business/mutasi_pekerjaan_pegawai.sql.php';
   ...
   function GetListMutasiPekerjaanPegawai($id) {
