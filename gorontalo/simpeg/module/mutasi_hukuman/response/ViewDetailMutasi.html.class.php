...
'module/mutasi_hukuman/business/mutasi_hukuman.class.php';
   ...
   class ViewDetailMutasi extends HtmlResponse
   {
      ...
      function ProcessRequest()
      {
         ...
         $return['link']['url_back'] = Dispatcher::Instance()->GetUrl('mutasi_hukuman','MutasiHukuman','view','html').'&id='.$profilId;
		 ...
		 if ($lang=='eng'){
			$return['title']="DISCIPLINARY MUTATION DETAIL";
		 }else{
			$return['title']="DETAIL RIWAYAT HUKUMAN";
		 }
		 $return['lang']=$lang;
		 return $return;
      }
