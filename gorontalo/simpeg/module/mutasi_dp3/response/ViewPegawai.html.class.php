...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='DAFTAR PENILAIAN PELAKSANAAN PEKERJAAN (DP3)';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiDp3',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
