...
class Laporan extends Database {
   ...
   protected $mSqlFile= 'module/laporan_kenaikangaji/business/laporan.sql.php';
...
//==GET== 
   ...
   function GetCountDataKenaikanGaji($awal, $akhir, $unit_kerja, $pangkat_golongan) {
   ...
   function GetDataKenaikanGaji($offset, $limit, $awal, $akhir, $unit_kerja, $pangkat_golongan) {
      $sql=$this->mSqlQueries['get_data_kenaikangaji']; 
      $list=$this->Obj->GetListIdAnakUnitByUnitId($unit_kerja);
      if($unit_kerja != "all"){
  		  $sql=str_replace('%unit_kerja%',' AND satkerpegSatkerId IN ('.$list.')' ,$sql);
