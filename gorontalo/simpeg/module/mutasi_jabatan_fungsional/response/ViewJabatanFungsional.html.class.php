...
class ViewJabatanFungsional extends HtmlResponse
{
   ...
   function ProcessRequest()
   {
	  ...
	  $return['link']['url_delete_js'] = Dispatcher::Instance()->GetUrl('mutasi_jabatan_fungsional', 'deleteJabatanFungsional', 'do', 'html');
		...
		Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'jenis_jabatan', array('ref_jab', $listJenisJabatan, $return['input']['ref_jab'], 'false', 'id="ref_jab" style="width:300px!important"'), Messenger::CurrentRequest);
