...
class Process{
  ...
  function __construct() {
    ...
    $this->pageView = Dispatcher::Instance()->GetUrl('agama', 'agama', 'view', 'html');
    $this->pageInput = Dispatcher::Instance()->GetUrl('agama', 'agama', 'view', 'html');
  ...
  function Check (){
    ...
    if (isset($error)){
      ...
      Messenger::Instance()->Send('agama', 'agama', 'view', 'html', $msg, Messenger::NextRequest);
