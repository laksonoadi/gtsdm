...
class Process
{
  ...
  function AddDatistri(){
    ...
    $array=array('id'=>$this->POST['idPeg'],'no_kartu'=>$this->POST['no_kartu'],'hubungan'=>$this->POST['hubungan'],'nama'=>$this->POST['nama'],
      'tmpt_lahir'=>$this->POST['tmpt_lahir'],'tgl_lahir'=>$a,'tgl_nikah'=>$b,'id_lain'=>$this->POST['id_lain'],
      'kerja'=>$this->POST['kerja'],'ket'=>$this->POST['ket'],'tunjangan'=>$this->POST['tunjangan'],'mati'=>$this->POST['mati'],
	  'npwp'=>$this->POST['npwp'],'telp'=>$this->POST['telp'],'educ'=>$this->POST['educ']);
    ...
    $array=array('no_kartu'=>$this->POST['no_kartu'],'hubungan'=>$this->POST['hubungan'],'nama'=>$this->POST['nama'],
      'tmpt_lahir'=>$this->POST['tmpt_lahir'],'tgl_lahir'=>$a,'tgl_nikah'=>$b,'id_lain'=>$this->POST['id_lain'],
      'kerja'=>$this->POST['kerja'],'ket'=>$this->POST['ket'],'tunjangan'=>$this->POST['tunjangan'],'mati'=>$this->POST['mati'],
      'npwp'=>$this->POST['npwp'],'telp'=>$this->POST['telp'],'educ'=>$this->POST['educ'],'id'=>$this->POST['idIstri']);
