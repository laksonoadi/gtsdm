...
//selesai bikin tombol delete
            ...
            if($dataGaji[$i]['id']==1){
               ...
               //$this->mrTemplate->AddVar('data1', 'DATA2_NUMBER', $dataGaji[$i]['number']);
            }else{  
               $this->mrTemplate->AddVar('data_item', 'DATA_1', 'NO');
               /*$this->mrTemplate->AddVar('data1', 'DATA1_ID', $dataGaji[$i]['id']);
               $this->mrTemplate->AddVar('data1', 'DATA1_NUMBER', $dataGaji[$i]['number']);
               $this->mrTemplate->AddVar('data1', 'DATA1_NAMA', $dataGaji[$i]['nama']);*/
            }
