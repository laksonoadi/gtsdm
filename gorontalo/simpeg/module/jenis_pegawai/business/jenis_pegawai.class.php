...
class JenisPegawai extends Database {

   protected $mSqlFile= 'module/jenis_pegawai/business/jenis_pegawai.sql.php';
...
//==GET==      
   ...
   function Add($data) {	   
      $return = $this->Execute($this->mSqlQueries['do_add'], array($data['nama'],$data['tipe'],$data['urut']));	  
      return $return;
   }  
	
   function Update($data) {
     $return = $this->Execute($this->mSqlQueries['do_update'], array($data['nama'],$data['tipe'],$data['urut'],$data['id']));         		  
		//$this->mdebug();  
      return $return;
   }   
