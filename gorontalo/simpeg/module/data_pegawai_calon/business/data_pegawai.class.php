...
class DataPegawai extends Database {
   ...
   protected $mSqlFile= 'module/data_pegawai_calon/business/data_pegawai.sql.php';
...
//==GET== 
   ...
   function Add($data) {	 
      ...
      $data['notaspen'],$data['noaskes'],$data['statusnpwp'],$data['nonpwp'],$data['usiapens'],
	  $data['kodeabsen'],$data['jnsidlain'],$data['jnspeg'],$data['statpeg'],
	  $data['satwilpeg'],$data['pegLevelId'],$data['pegStatusWargaNeg'],$data['foto'],$data['userId']);
   ...
   function Update($data) {	   
      ...
      $data['notaspen'],$data['noaskes'],$data['statusnpwp'],$data['nonpwp'],$data['usiapens'],
	  $data['kodeabsen'],$data['jnsidlain'],$data['jnspeg'],$data['statpeg'],
	  $data['satwilpeg'],$data['pegLevelId'],$data['pegStatusWargaNeg'],$data['foto'],$data['userId'],$data['id']);

      $return = $this->Execute($this->mSqlQueries['do_update'],$params);	//print_r($this->getLastError());exit;  
      return $return;
   }  
