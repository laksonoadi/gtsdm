...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='RIWAYAT BINTANG TANDA JASA';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiBintangTandaJasa',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
