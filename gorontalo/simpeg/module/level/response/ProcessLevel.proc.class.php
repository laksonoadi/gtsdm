...
class Process{
  ...
  function __construct() {
    ...
    $this->pageView = Dispatcher::Instance()->GetUrl('level', 'level', 'view', 'html');
    $this->pageInput = Dispatcher::Instance()->GetUrl('level', 'level', 'view', 'html');
  ...
  function Check (){
    ...
    if (isset($error)){
      ...
      Messenger::Instance()->Send('level', 'level', 'view', 'html', $msg, Messenger::NextRequest);
