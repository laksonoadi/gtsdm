...
class Mertua extends Database {

   protected $mSqlFile= 'module/data_mertua/business/data_mertua.sql.php';
...
//==GET== 
   ...
   function GetDataMertua($id) {      
      $result = $this->Open($this->mSqlQueries['get_data_mertua'], array($id)); 
	     return $result;	  
   }

   function GetDataMertuaVerifikasi($id) {      
      $result = $this->Open($this->mSqlQueries['get_data_mertua_verifikasi'], array($id)); 
       return $result;    
   }
   
   function GetDataMertuaDet($id) {      
      $result = $this->Open($this->mSqlQueries['get_data_mertua_det'], array($id)); 
