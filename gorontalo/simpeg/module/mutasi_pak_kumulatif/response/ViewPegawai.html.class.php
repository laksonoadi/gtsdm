...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='MUTASI PENGAJUAN ANGKA KREDIT';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiPak',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
