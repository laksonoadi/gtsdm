...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new TipePelatihan;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('tipe_pelatihan', 'TipePelatihan', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('tipe_pelatihan', 'TipePelatihan', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('tipe_pelatihan', 'TipePelatihan', 'view', 'html', $msg, Messenger::NextRequest);
