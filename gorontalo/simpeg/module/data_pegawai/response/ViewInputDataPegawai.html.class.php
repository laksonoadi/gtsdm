...
class ViewInputDataPegawai extends HtmlResponse {
   ...
   function PrepareData(){
    ...
    ,'datpegNoKir'=>$rs['pegKir'],'datpegNoTaspen'=>$rs['pegNoTaspen'],'datpegNoAskes'=>$rs['pegNoAskes']
    ...
    ,'pegRumah'=>$rs['pegRumah'],'pegJenFungsional'=>$rs['pegJenFungsional']
      ...
      $this->Op = $post['op'];
      //print_r($this->Op);
      $this->Data = array('id'=>$post['pegId'],'nip'=>$post['pegKodeResmi'],'kodegateaccess'=>$rs['pegKodeGateAccess'],'kodeint'=>$post['pegNipLama'],'kodelain'=>$post['pegKodeLain'],
      ...
      'pnstmt'=>date("Y-m-d"),'cpnstmt'=>date("Y-m-d"),'tglmasuk'=>date("Y-m-d"),'notaspen'=>$post['pegNoTaspen'],'noaskes'=>$post['pegNoAskes'],'statusnpwp'=>$rs['pegStatusNpwp'],
      'nonpwp'=>$post['datpegNoNpwp'],'usiapens'=>$post['pegUsiaPensiun'],'statr'=>$post['pegStatrId'],'geldep'=>$post['pegGelarDepan'],
    ...
    ,'datpegSKCK'=>$post['datpegSkck'],'pegNoKarpeg'=>$post['datpegNoKarpeg'],'datpegNoKpe'=>$post['pegNoKpe']
    ,'datpegNoKir'=>$post['datpegKir'],'datpegNoTaspen'=>$post['datpegNoTaspen'],'datpegNoAskes'=>$post['pegNoAskes']
    ,'pegKelurahan'=>$post['datpegKelurahan'],'pegKecamatan'=>$post['datpegKecamatan'],'datpegBahasa'=>$post['datpegBahasa']
  ...
  $return['bahasa'] = $ObjDatPeg->GetComboBahasa();
   ...
   function ParseTemplate($data = NULL) {
    ...
    if(in_array($bahasa[$i]['id'], $this->Data['datpegBahasa']))$bahasa[$i]['checked'] = 'checked';
