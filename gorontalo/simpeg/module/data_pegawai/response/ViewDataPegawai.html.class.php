  ...
  //mulai bikin tombol delete
        ...
        $total=0;
  			for ($i=0; $i<sizeof($dataPegawai); $i++) {
  				...
  				switch($dataPegawai[$i]['verStatus']) {
                    case 4: $dataPegawai[$i]['class_name'] = 'item-ver-red'; break;
                    case 3: $dataPegawai[$i]['class_name'] = ''; break;
                    case 2: $dataPegawai[$i]['class_name'] = 'item-ver-blue'; break;
                    default: $dataPegawai[$i]['class_name'] = 'item-ver-yellow'; break;
                }
  				/* if ($no % 2 != 0) {
