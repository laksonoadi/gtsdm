...
class Laporan extends Database {
   ...
   protected $mSqlFile= 'module/laporan_pegawai_status/business/laporan.sql.php';
...
//==GET== 
   ...
   function GetComboStatusPegawai(){
      $result=$this->Open($this->mSqlQueries['get_combo_status_pegawai'],array());
      /*$i=sizeof($result);
      $result[$i]['id']=99999;
      $result[$i]['name']='Belum Diset';*/
      return $result;
   ...
   function GetDataPegawai($offset, $limit, $jabatan_fungsional) {
