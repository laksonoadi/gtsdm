...
class MutasiDp4 extends Database {

   protected $mSqlFile= 'module/mutasi_dp4/business/mutasi_dp4.sql.php';
   ...
   function GetListMutasiDp4($id) {
     $result = $this->Open($this->mSqlQueries['get_list_mutasi_dp4'], array($id));
     return $result; 
   }
   
   function GetDataMutasiById($id,$dataId) {
     $result = $this->Open($this->mSqlQueries['get_data_mutasi_dp4_by_id'], array($id,$dataId));
     //
     return $result;
   }
