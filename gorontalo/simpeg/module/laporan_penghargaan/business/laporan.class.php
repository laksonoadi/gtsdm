...
class Laporan extends Database {
   ...
   protected $mSqlFile= 'module/laporan_penghargaan/business/laporan.sql.php';
...
//==GET== 
   ...
   function GetCountDataPenghargaan($awal, $akhir, $unit_kerja, $pangkat_golongan) {
      $sql=$this->mSqlQueries['get_data_penghargaan']; 
   ...
   function GetDataPenghargaan($offset, $limit, $awal, $akhir, $unit_kerja, $pangkat_golongan) {
      $sql=$this->mSqlQueries['get_data_penghargaan']; 
      $list=$this->Obj->GetListIdAnakUnitByUnitId($unit_kerja);
      if($unit_kerja != "all"){
  		  $sql=str_replace('%unit_kerja%',' AND satkerpegSatkerId IN ('.$list.')' ,$sql);
