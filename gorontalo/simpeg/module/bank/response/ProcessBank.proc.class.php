...
class Process{
  ...
  function __construct() {
    ...
    $this->pageView = Dispatcher::Instance()->GetUrl('bank', 'bank', 'view', 'html');
    $this->pageInput = Dispatcher::Instance()->GetUrl('bank', 'bank', 'view', 'html');
  ...
  function Check (){
    ...
    if (isset($error)){
      ...
      Messenger::Instance()->Send('bank', 'bank', 'view', 'html', $msg, Messenger::NextRequest);
