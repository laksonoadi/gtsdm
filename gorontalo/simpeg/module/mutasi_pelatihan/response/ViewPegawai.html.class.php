...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='RIWAYAT PELATIHAN/TRAINING';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiPelatihan',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
