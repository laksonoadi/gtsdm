...
class OrangTua extends Database {
   ...
   protected $mSqlFile= 'module/data_orang_tua/business/data_orang_tua.sql.php';
...
//==GET== 
   ...
   function GetDataOrtu($id) {      
      $result = $this->Open($this->mSqlQueries['get_data_ortu'], array($id)); 
	     return $result;	  
   }

   function GetDataOrtuVerifikasi($id) {      
      $result = $this->Open($this->mSqlQueries['get_data_ortu_verifikasi'], array($id)); 
       return $result;    
   }
   
   function GetDataOrtuDet($id) {      
      $result = $this->Open($this->mSqlQueries['get_data_ortu_det'], array($id)); 
