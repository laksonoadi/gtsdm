...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new BidangIlmu;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('bidang_ilmu', 'BidangIlmu', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('bidang_ilmu', 'BidangIlmu', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('bidang_ilmu', 'BidangIlmu', 'view', 'html', $msg, Messenger::NextRequest);
