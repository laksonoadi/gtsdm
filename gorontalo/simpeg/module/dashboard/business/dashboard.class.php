...
class dashboard extends Database {
    ...
    function GetListPegawaiMasukPertahun(){
      ...
      $result = $this->Open($this->mSqlQueries['get_count_pegawai_masuk_pertahun'], array($resultunitgroup));
      return $result;
   }
   ...
   function GetCountJenisPegawaiTotal($jenis_pegawai){
     ...
     $userId = Security::Instance()->mAuthentication->GetCurrentUser()->GetUserId();//$this->GetUserIdByUserName();
      ...
      $result = $this->Open($this->mSqlQueries['get_jenis_pegawai_data'], array($resultunitgroup,$jenis_pegawai));
    ...
    function GetCountPegawaiPensiun($nip_nama='',$status=''){
     ...
     $status_kerja = "AND a.pegStatrId =$status";
      ...
      $status_kerja = "1=1";
         ...
         $result = $this->Open($this->mSqlQueries['get_count_pegawai_pensiun'], array('%'.$nip_nama.'%','%'.$nip_nama.'%',$resultunitgroup,$satker,$status_kerja));
        $res3 = sizeof($result); 
        if(!$res3){
          return 0;
      }
...
function GetCountPejabatFungsionalTotal($jenis_pegawai){
