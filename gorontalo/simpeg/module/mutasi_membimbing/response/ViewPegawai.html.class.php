...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='RIWAYAT MEMBIMBING/MENGUJI';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiMembimbing',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
