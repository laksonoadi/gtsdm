...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new JenisPenghargaan;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('jenis_penghargaan', 'jenisPenghargaan', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('jenis_penghargaan', 'jenisPenghargaan', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('jenis_penghargaan', 'jenisPenghargaan', 'view', 'html', $msg, Messenger::NextRequest);
