   ...
   function ProcessRequest()
   {
      ...
      $this->fColData = $this->mrWorkbook->add_format();
    	...
    	$this->mWorksheets['Duk']->merge_cells($row, 0, $row,$jumKolom-1);
		  ...
		  //Set Header
		  $header[0]=array('No.','Nama','NIP','Pangkat',''
                       ,'Jabatan','','Masa Kerja','','Latihan Jabatan',''
                       ,'','Pendidikan','','',''
                       ,'Tanggal lahir','Catatan Mutasi Kepegawaian');
		  $header[1]=array('','','','Gol','TMT'
                       ,'Nama','TMT','Thn','Bln','Tahun','Nama'
                       ,'Jam','Nama','Jurusan','Tahun','Tingkat'
                       ,'','');
                       
		  //Set Nama Variabel Yang akan ditulis
		  $val=array('no','nama','nip','golongan','golongan_tmt'
                 ,'jabatan','jabatan_tmt','masa_kerja_tahun','masa_kerja_bulan','latihan_thn','latihan_nm'
                 ,'latihan_jm','pendidikan_nama','pendidikan_jurusan','pendidikan_lulus','pendidikan_tingkat'
                 ,'tanggal_lahir','');
