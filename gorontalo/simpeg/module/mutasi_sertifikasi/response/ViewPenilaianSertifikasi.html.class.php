...
class ViewPenilaianSertifikasi extends HtmlResponse{
	...
	function ParseTemplate($data = NULL){
		...
		$this->mrTemplate->AddVar('content', 'URL_BACK', Dispatcher::Instance()->GetUrl('mutasi_sertifikasi', 'historyDataSertifikasi', 'view', 'html'));
		$this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('mutasi_sertifikasi', 'penilaianSertifikasi', 'view', 'html').'&srtfkId='.$_GET['srtfkId']);
		$this->mrTemplate->AddVar('content', 'URL_AKSI', Dispatcher::Instance()->GetUrl('mutasi_sertifikasi', 'inputDataSertifikasi', 'do', 'html')); 
		$this->mrTemplate->AddVar('content', 'URL_POPUP_PEGAWAI', Dispatcher::Instance()->GetUrl('mutasi_sertifikasi', 'popupPegawai', 'view', 'html'));
