...
class Process{
  ...
  function __construct() {
    $this->Obj = new JenisDokumenKelengkapan;
    $this->_POST = $_REQUEST->AsArray();
    $this->decId = $_GET['id']->Integer()->Raw();
    $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
    $this->encId = $this->decId;
    $this->pageView = Dispatcher::Instance()->GetUrl('jenis_dokumen_kelengkapan', 'jenisDokumenKelengkapan', 'view', 'html');
    $this->pageInput = Dispatcher::Instance()->GetUrl('jenis_dokumen_kelengkapan', 'jenisDokumenKelengkapan', 'view', 'html');
  ...
  function Check (){
    ...
    if (isset($error)){
      ...
      Messenger::Instance()->Send('jenis_dokumen_kelengkapan', 'jenisDokumenKelengkapan', 'view', 'html', $msg, Messenger::NextRequest);
  ...
  function Update(){
    ...
    $data=array('nama'=>$this->_POST['nama'],'keterangan'=>$this->_POST['keterangan'],'id'=>$this->decId);
  ...
  function Add(){
    ...
    $data=array('nama'=>$this->_POST['nama'],'keterangan'=>$this->_POST['keterangan']);//print_r($data);
