...
class ViewInputJabatanStruktural extends HtmlResponse {
   ...
   function TemplateModule() {
      ...
      $this->SetTemplateFile('input_jabatan_struktural.html');    
   } 
   ...
   function ParseTemplate ($data = NULL){
       ...
       if(empty($data['jabstruk'])){
            ...
            $this->mrTemplate->AddVar("content", "JENIS_STRUKTUR", $data['jabstruk'][0]['kompid']);
