...
$sql['do_add_jabstruk'] ="
   ...
   (jabstrukrNama, jabstrukrTingkat, jabstrukrBatasUsiaPensiun, jabstrukTpstrId, jabstrukKompgajidtId, jabstrukrSatker, jabstrukrKomp)
   VALUES
   ('%s','%s','%s','%s','%s','%s','%s')
";
