...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new JenisPendapatanLain;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('jenis_pendapatan_lain', 'JenisPendapatanLain', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('jenis_pendapatan_lain', 'JenisPendapatanLain', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('jenis_pendapatan_lain', 'JenisPendapatanLain', 'view', 'html', $msg, Messenger::NextRequest);
   ...
   function Add()
   {
     $check = $this->Check();
	  ...
	  $data=array('nama'=>$this->_POST['nama']);//print_r($data);
