...
class ViewLaporanDp4 extends HtmlResponse
{
   function TemplateModule()
   {
      $this->SetTemplateBasedir(GTFWConfiguration::GetValue('application','docroot').'module/laporan_dp4/'.GTFWConfiguration::GetValue('application', 'template_address').'');
      $this->SetTemplateFile('view_laporan_dp4.html');
   }
   ...
   function ProcessRequest()
   {
      ...
      $totalData = $this->Obj->GetCountDataDp4($this->awal,$this->akhir,$this->unit_kerja, $this->pangkat_golongan);
  		...
  		$dataPegawai = $this->Obj->GetDataDp4($startRec, $itemViewed, $this->awal,$this->akhir,$this->unit_kerja, $this->pangkat_golongan);
   ...
   function ParseTemplate($data = NULL)
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_SEARCH', Dispatcher::Instance()->GetUrl('laporan_dp4', 'laporanDp4', 'view', 'html') );
      $this->mrTemplate->AddVar('content', 'URL_EXCEL', Dispatcher::Instance()->GetUrl('laporan_dp4', 'laporanDp4', 'view', 'xls')
        .'&unit_kerja=' . Dispatcher::Instance()->Encrypt($this->unit_kerja)
        .'&pangkat_golongan=' . Dispatcher::Instance()->Encrypt($this->pangkat_golongan)
        .'&awal=' . Dispatcher::Instance()->Encrypt($this->awal)
        .'&akhir=' . Dispatcher::Instance()->Encrypt($this->akhir)
