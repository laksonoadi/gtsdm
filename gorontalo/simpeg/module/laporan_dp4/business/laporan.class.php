...
class Laporan extends Database {
   ...
   protected $mSqlFile= 'module/laporan_dp4/business/laporan.sql.php';
...
//==GET== 
   ...
   function GetCountDataDp4($awal, $akhir, $unit_kerja, $pangkat_golongan) {
      $sql=$this->mSqlQueries['get_data_dp4']; 
   ...
   function GetDataDp4($offset, $limit, $awal, $akhir, $unit_kerja, $pangkat_golongan) {
      $sql=$this->mSqlQueries['get_data_dp4']; 
