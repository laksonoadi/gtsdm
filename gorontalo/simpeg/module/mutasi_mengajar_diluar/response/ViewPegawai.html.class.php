...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='RIWAYAT MENGAJAR DI LUAR';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiMengajarDiluar',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
