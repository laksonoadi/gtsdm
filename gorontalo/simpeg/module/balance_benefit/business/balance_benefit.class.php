...
class BalanceBenefit extends Database {

  protected $mSqlFile= 'module/balance_benefit/business/balance_benefit.sql.php';
...
//==GET== 
   function GetCountPegawai($nip_nama='') {
      if($nip_nama != ""){
   ...
   function GetDataPegawai ($offset, $limit, $nip_nama='') { 
      if($nip_nama != ""){
  		  $str = " WHERE (pegKodeResmi LIKE '%".$nip_nama."%' OR pegNama LIKE '%".$nip_nama."%')";
      }else{
        $str = "";
  ...
  function GetData ($offset, $limit, $data) {
    $result = $this->Open($this->mSqlQueries['get_data'], array($data['pegId'],$data['balancebenefitAwalSearch'],$data['balancebenefitAkhirSearch'],$offset,$limit));
    $x = sprintf($this->mSqlQueries['get_data'], $data['pegId'],$data['balancebenefitAwalSearch'],$data['balancebenefitAkhirSearch'],$offset,$limit);
    //print_r($x);
    return $result;
  }
  ...
  function Add($data) {	  
    $return = $this->Execute($this->mSqlQueries['do_add'], array($data['pegId'],$data['awal'],$data['akhir'],$data['total'],$data['status']));	  
    return $return;
  }  
  
  function Update($data) {
    $return = $this->Execute($this->mSqlQueries['do_update'], array($data['pegId'],$data['awal'],$data['akhir'],$data['total'],$data['status'],$data['id']));         		  
