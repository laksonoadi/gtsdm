...
class ViewJenisPolicy extends HtmlResponse {
   ...
   function ParseTemplate($data = NULL) {
      ...
      $urlBalik = Dispatcher::Instance()->GetUrl('manajemen_policy','JenisPolicy','View','html');
      $this->mrTemplate->addVar('content','URL_BALIK',$urlAction);
   ...
   function DoUpdate(){
      return $this->mPolicy->UpdateType($_POST['nama'],$_POST['dataId']);
   }
