...
class Process
{
   var $_POST;
	...
	function __construct() {
	   $this->Obj = new Pekerjaan;
	   $this->_POST = $_REQUEST->AsArray();
	   $this->decId = $_GET['id']->Integer()->Raw();
	   $this->user=Security::Authentication()->GetCurrentUser()->GetUserId();
	   $this->encId = $this->decId;
	   $this->pageView = Dispatcher::Instance()->GetUrl('pekerjaan', 'pekerjaan', 'view', 'html');
	   $this->pageInput = Dispatcher::Instance()->GetUrl('pekerjaan', 'pekerjaan', 'view', 'html');
	...
	function Check ()
   {
	  ...
	  if (isset($error))
      {
         ...
         Messenger::Instance()->Send('pekerjaan', 'pekerjaan', 'view', 'html', $msg, Messenger::NextRequest);
