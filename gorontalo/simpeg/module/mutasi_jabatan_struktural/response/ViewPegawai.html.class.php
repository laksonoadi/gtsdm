...
class ViewPegawai extends HtmlResponse {
    ...
    function ProcessRequest() {
		$judul='MUTASI JABATAN STRUKTURAL';
		...
		$urlSelect=Dispatcher::Instance()->GetUrl(Dispatcher::Instance()->mModule,'MutasiJabatanStruktural',Dispatcher::Instance()->mAction, Dispatcher::Instance()->mType);
