   ...
   function ProcessRequest()
   {
      ...
      $this->fColData = $this->mrWorkbook->add_format();
    	...
    	$row++;
		  ...
		  $header[1]=array('','','','','','','','Jumlah Lama','Jumlah Baru','Digunakan','Lebihan','','');
		  //Set Nama Variabel Yang akan ditulis
		  $val=array('no','nip','nama','jenis_kelamin','jabatan','golongan','unit_kerja','pak_jumlah_lama','pak_jumlah_baru','pak_jumlah_digunakan','pak_jumlah_lebihan','dapat_diangkat','tanggal_pak');
