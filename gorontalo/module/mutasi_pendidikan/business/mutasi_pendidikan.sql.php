...
SELECT 
	p.pddkId as id,
	p.pddkPegKode as nip,
    pge.pegKodeResmi as nip_pegawai,	
	p.pddkTkpddkrId as jpendid,
	p.pddkInstitusi as institusi,
	p.pddkJurusan as jurusan,
	p.pddkThnLulus as lulus,
	...
	jp.pendNama as jpendlabel,
	n.satwilNama as neglabel,
	n.satwilKode as negkode,
	pendPendkelId as kelompok,
...
FROM
	...
	LEFT JOIN pub_pegawai pge ON (p.pddkPegKode=pge.pegId)
WHERE 
   p.pddkPegKode='%s' AND
   p.pddkId='%s' 
"; 
...
$sql['do_add'] = "
INSERT INTO 
   sdm_pendidikan(pddkPegKode,pddkTkpddkrId,pddkInstitusi,pddkJurusan,pddkThnLulus,pddkTempat,pddkKepala,pddkNegaraId,pddkAsldnrId,pddkLamaDinas,pddkTglMulaiDinas,pddkTglSelesaiDinas,pddkKeterangan,pddkPktGolMax,pddkStatusTamat,pddkUpload
   )
VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')   
";

$sql['do_add_integrasi'] = "
INSERT INTO pg_pendidikan_formal(
					pdfPegNip,
					pdfNoUrut,
					pdfJjarkode,
					pdfInstitusi,
