...
class ViewMutasiKunjungan extends HtmlResponse
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_TAMBAH', Dispatcher::Instance()->GetUrl('mutasi_kunjungan', 'MutasiKunjungan', 'view', 'html').'&aksi=ya');
      $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('mutasi_kunjungan', 'MutasiKunjungan', 'view', 'html'));
      ...
      $dataName = $dataKunj[$i]['tujuan'];
         ...
         $dataKunj[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('mutasi_kunjungan','MutasiKunjungan', 'view', 'html').'&id='.$dataPegawai[0]['id'].'&dataId='. $idEnc.'&aksi=ya';
