...
'module/mutasi_kunjungan/business/mutasi_kunjungan.class.php';
   ...
   class ViewDetailMutasi extends HtmlResponse
   {
      ...
      function ProcessRequest()
      {
         ...
         $return['link']['url_back'] = Dispatcher::Instance()->GetUrl('mutasi_kunjungan','MutasiKunjungan','view','html').'&id='.$profilId;
      ...
      function ParseTemplate($data = NULL)
      {
         ...
         if($data['lang']=='eng') {
    	  	$this->mrTemplate->AddVar('content', 'TITLE', 'OVERSEAS VISITS MUTATION DETAIL');
    	  } else {
    		  $this->mrTemplate->AddVar('content', 'TITLE', 'DETAIL MUTASI KUNJUNGAN KE LUAR NEGERI');
    	  }
         ...
         if($data['lang']=='eng') {
           $value['mulai'] = $this->date2stringEng($value['mulai']);
           $value['selesai'] = $this->date2stringEng($value['selesai']);
         } else {
