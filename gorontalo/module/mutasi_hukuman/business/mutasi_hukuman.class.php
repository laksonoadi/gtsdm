...
class MutasiHukuman extends Database {

   protected $mSqlFile= 'module/mutasi_hukuman/business/mutasi_hukuman.sql.php';
   ...
   function GetListMutasiHukuman($id) {
   $result = $this->Open($this->mSqlQueries['get_list_mutasi_hukuman'], array($id));
   return $result;
   ...
   function GetCountMutasi($id) {
    ...
    function GetComboJenisHukuman() {
		$result = $this->Open($this->mSqlQueries['get_combo_jenis_hukuman'], array());
