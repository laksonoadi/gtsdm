...
class MutasiSeminar extends Database {

   protected $mSqlFile= 'module/mutasi_seminar/business/mutasi_seminar.sql.php';
   ...
   function GetListMutasiSeminar($id) {
   $result = $this->Open($this->mSqlQueries['get_list_mutasi_seminar'], array($id));
   //echo sprintf($this->mSqlQueries['get_list_mutasi_seminar'],$id);
   return $result;
      
   }
   
   function GetDataMutasiById($id,$dataId) {
   $result = $this->Open($this->mSqlQueries['get_data_mutasi_seminar_by_id'], array($id,$dataId));
   return $result;
   ...
   function GetCountMutasi($id) {
    ...
    function GetComboTingkatSeminar() {
		$result = $this->Open($this->mSqlQueries['get_combo_tingkat_seminar'], array());
