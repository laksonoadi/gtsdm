	...
	function InputData(){
      ...
      if ((isset($this->POST['btnsimpan'])) && empty($this->decId)) {
        ...
        if($rs_add == true){
           ...
           Messenger::Instance()->Send('mutasi_pekerjaan_pegawai','MutasiPekerjaanPegawai','view','html', array($this->POST,'Penambahan Data Berhasil',$this->cssDone),Messenger::NextRequest);
           return $this->pageView;
        }else{
