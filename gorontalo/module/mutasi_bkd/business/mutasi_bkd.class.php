...
class MutasiBkd extends Database {

   protected $mSqlFile= 'module/mutasi_bkd/business/mutasi_bkd.sql.php';
...
// ADD PENDIDIKAN -----------------------------------------------------------------------------------------------------------------------------------
   function AddPendidikan($data) {
    $return = $this->Execute($this->mSqlQueries['do_add_pendidikan'], $data);
    // 
	// exit;
    return $return;
   }  	
...
// ADD PENGABDIAN -----------------------------------------------------------------------------------------------------------------------------------
   function AddPengabdian($data) {
    $return = $this->Execute($this->mSqlQueries['do_add_pengabdian'], $data);
    // 
	// exit;
    return $return;
   }  
...
// ADD PENUNJANG -----------------------------------------------------------------------------------------------------------------------------------
   function AddPenunjang($data) {
    $return = $this->Execute($this->mSqlQueries['do_add_penunjang'], $data);
    // 
	// exit;
    return $return;
   }  
...
// ADD PROFESOR -----------------------------------------------------------------------------------------------------------------------------------
   function AddProfesor($data) {
    $return = $this->Execute($this->mSqlQueries['do_add_profesor'], $data);
    // 
	// exit;
    return $return;
   }  
