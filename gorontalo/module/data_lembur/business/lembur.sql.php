...
SELECT
	...
	TIME_FORMAT(a.lemburMulai, '%s') as 'start_jam',
	TIME_FORMAT(a.lemburMulai, '%s') as 'start_menit',
  TIME_FORMAT(a.lemburSelesai, '%s') as 'selesai',
  TIME_FORMAT(a.lemburSelesai, '%s') as 'end_jam',
	TIME_FORMAT(a.lemburSelesai, '%s') as 'end_menit',
  TIME_FORMAT(TIMEDIFF(a.lemburSelesai, a.lemburMulai), '%s') as 'durasi',
	a.lemburAlasan as 'alasan',
	a.lemburStatus as 'status',
	DATE_FORMAT(a.lemburTglStatus,'%s') as 'tglstat'
FROM
	sdm_lembur a
WHERE
	a.lemburId = '%s'
