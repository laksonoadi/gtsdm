...
class ViewMutasiPenghargaan extends HtmlResponse
   {
      ...
      //print_r($dataPegawai);
      //print_r($dataPeng);
      $this->mrTemplate->AddVar('content', 'TITLE', 'PENGHARGAAN');
      ...
      $this->mrTemplate->AddVar('content', 'URL_TAMBAH', Dispatcher::Instance()->GetUrl('mutasi_penghargaan', 'MutasiPenghargaan', 'view', 'html').'&aksi=ya');
      $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('mutasi_penghargaan', 'MutasiPenghargaan', 'view', 'html'));
      ...
      $dataName = $dataPeng[$i]['nama'];
         ...
         $dataPeng[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('mutasi_penghargaan','MutasiPenghargaan', 'view', 'html').'&id='.$dataPegawai[0]['id'].'&dataId='. $idEnc.'&aksi=ya';
