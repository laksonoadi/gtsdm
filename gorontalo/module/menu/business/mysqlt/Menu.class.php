...
class Menu extends Database {
   ...
   function GetParent($menuName) {
   	//die('tet');
		#printf($this->mSqlQueries['list_all_available_submenu_for_group'], $userId,$menuId);
      $result = $this->Open($this->mSqlQueries['get_parent'], array($menuName));
      return $result;
   }
   
   function GetParentMenuIdByModule($moduleName){
      $result = $this->Open($this->mSqlQueries['get_parent_menu_id_by_module_name'], array($moduleName));
      return $result;
   }
}
?>
