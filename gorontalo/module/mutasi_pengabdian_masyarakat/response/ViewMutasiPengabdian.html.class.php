<?php
require_once GTFWConfiguration::GetValue( 'application', 'docroot').  'module/mutasi_pengabdian_masyarakat/business/mutasi_pengabdian.class.php';
...
class ViewMutasiPengabdian extends HtmlResponse
   {
      ...
      $this->mrTemplate->AddVar('content', 'URL_TAMBAH', Dispatcher::Instance()->GetUrl('mutasi_pengabdian_masyarakat', 'MutasiPengabdian', 'view', 'html').'&aksi=ya');
      $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('mutasi_pengabdian_masyarakat', 'MutasiPengabdian', 'view', 'html'));
      ...
      $dataName = $dataPel[$i]['nama'];
         ...
         $dataPel[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('mutasi_pengabdian_masyarakat','MutasiPengabdian', 'view', 'html').'&id='.$dataPegawai[0]['id'].'&dataId='. $idEnc.'&aksi=ya';
