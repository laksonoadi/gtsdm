...
'module/mutasi_pengabdian_masyarakat/business/mutasi_pengabdian.class.php';
   ...
   class ViewDetailMutasi extends HtmlResponse
   {
      ...
      function ProcessRequest()
      {
         ...
         $return['link']['url_back'] = Dispatcher::Instance()->GetUrl('mutasi_pengabdian_masyarakat','MutasiPengabdian','view','html').'&id='.$profilId;
      ...
      function ParseTemplate($data = NULL)
      {
         ...
         if($data['lang'] = 'eng'){
           $this->mrTemplate->AddVar('content', 'TITLE', 'TRAINING MUTATION DETAIL');
         } else {
           $this->mrTemplate->AddVar('content', 'TITLE', 'DETAIL MUTASI PELATIHAN');         
         }
