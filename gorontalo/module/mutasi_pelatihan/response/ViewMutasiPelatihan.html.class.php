...
class ViewMutasiPelatihan extends HtmlResponse
   {
      ...
      $arras = $pel->GetComboAsalDana();
         ...
         $return['link']['link_download']=GTFWConfiguration::GetValue( 'application', 'file_downlaod_path');
      ...
      //print_r($dataPegawai);
      //print_r($dataPel);
      $this->mrTemplate->AddVar('content', 'TITLE', 'PELATIHAN');
      ...
      $this->mrTemplate->AddVar('content', 'URL_TAMBAH', Dispatcher::Instance()->GetUrl('mutasi_pelatihan', 'MutasiPelatihan', 'view', 'html').'&aksi=ya');
      $this->mrTemplate->AddVar('content', 'URL_KEMBALI', Dispatcher::Instance()->GetUrl('mutasi_pelatihan', 'MutasiPelatihan', 'view', 'html'));
      ...
      $dataName = $dataPel[$i]['nama'];
         ...
         $dataPel[$i]['URL_EDIT'] = Dispatcher::Instance()->GetUrl('mutasi_pelatihan','MutasiPelatihan', 'view', 'html').'&id='.$dataPegawai[0]['id'].'&dataId='. $idEnc.'&aksi=ya';
