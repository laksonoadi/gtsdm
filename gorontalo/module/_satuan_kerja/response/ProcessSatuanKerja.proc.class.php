...
class Process{
   ...
   function AddSatker(){
	  ...
	  $array=array('level'=>$level,'unit'=>$this->POST['satkerUnitId'],'nama'=>$this->POST['satkerNama'],'user'=>$this->user);
   ...
   function UpdateSatker(){
	  ...
	  $array=array('level'=>$level,'unit'=>$this->POST['satkerUnitId'],'nama'=>$this->POST['satkerNama'],'user'=>$this->user,'id'=>$this->POST['satkerId']);
