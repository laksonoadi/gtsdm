...
class ManajemenAgenda extends Database {
   ...
   function AddAgenda($nama,$artikel,$tanggal_mulai,$tanggal_selesai,$tempat,$url,$foto,$caption_foto,$status,$pengirim){
      return $this->Execute($this->mSqlQueries['add_agenda'],array($nama,$artikel,$tanggal_mulai,$tanggal_selesai,$tempat,$url,$foto,$caption_foto,$status,$pengirim));
   }
   
   function UpdateAgenda($nama,$artikel,$tanggal_mulai,$tanggal_selesai,$tempat,$url,$foto,$caption_foto,$status,$pengirim,$id){
      return $this->Execute($this->mSqlQueries['update_agenda'],array($nama,$artikel,$tanggal_mulai,$tanggal_selesai,$tempat,$url,$foto,$caption_foto,$status,$pengirim,$id));
   }
