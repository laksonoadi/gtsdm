...
class ViewDataCuti extends HtmlResponse{
	...
	function ProcessRequest(){
      ...
      if ($_GET['dataId'] != '') {
		...
		Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'reduced', array('reduced',$arrReduced,$reduced,'',' style="width:100px;" '), Messenger::CurrentRequest);
		Messenger::Instance()->SendToComponent('combobox', 'Combobox', 'view', 'html', 'status', array('status',$arrStatus,$status,'',' style="width:150px;"'), Messenger::CurrentRequest);  
