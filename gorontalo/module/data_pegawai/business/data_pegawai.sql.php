...
$sql['get_combo_pegawai_departement']="
select distinct
  pegId as id,
  pegNama as name
from 
  pub_pegawai
  INNER JOIN sdm_satuan_kerja_pegawai ON satkerpegPegId=pegId
WHERE 
  satkerpegSatkerId IN ( Select satkerpegSatkerId from sdm_satuan_kerja_pegawai where satkerpegPegId=%s)
";
...
INSERT INTO 
   pub_pegawai
   (pegKodeResmi,pegKodeInternal,pegKodeLain,
	pegNama,pegGelarDepan,pegTmpLahir,pegTglLahir,
	...
	pegNoTaspen,pegNoAskes,pegNoNpwp,pegUsiaPensiun,
	pegKodeAbsen,pegJenisIdLain,pegJnspegrId,pegStatrId,
	pegSatwilId,pegFoto,pegCreationDate,pegUserId)
...
$sql['do_update_data_rek'] = "
   UPDATE pub_pegawai_rekening
   SET
      pegrekBankId=%s,
      pegrekRekening='%s',
      pegrekCreationDate=now(),
      pegrekUserId=%s
   WHERE
      pegrekPegId=%s
";
